...
const SLUG_SYNONYMS: Record<string, string[]> = {
  garments: ['clothing', 'garment', 'tee', 't-shirt', 'shirt', 'top', 'blouse', 'knit', 'knitwear', 'tank', 'cardigan', 'sweater', 'jumper', 'vest', 'polo', 'turtleneck'],
  hoodies: ['hoodie', 'sweatshirt', 'pullover', 'crewneck'],
  dresses: ['dress', 'gown', 'maxi', 'midi', 'mini dress', 'slip dress', 'sundress'],
  jeans: ['jean', 'denim'],
  jackets: ['jacket', 'blazer', 'coat', 'puffer', 'trench', 'overcoat', 'parka', 'windbreaker', 'bomber', 'outerwear'],
  activewear: ['activewear', 'sportswear', 'gym', 'yoga', 'pilates', 'athleisure', 'leggings', 'workout', 'training', 'running', 'fitness', 'sport', 'cycling', 'tracksuit'],
  ...
  sneakers: ['sneaker', 'trainer', 'runner', 'kicks', 'low-top', 'high-top'],
  boots: ['boot', 'bootie', 'chelsea', 'combat boot', 'western boot', 'knee-high'],
  ...
  'beauty-skincare': ['skincare', 'serum', 'moisturizer', 'cream', 'cleanser', 'toner', 'mask', 'exfoliant', 'peel', 'retinol', 'spf', 'sunscreen', 'balm', 'oil'],
  'makeup-lipsticks': ['lipstick', 'makeup', 'mascara', 'foundation', 'blush', 'lip gloss', 'gloss', 'liner', 'palette', 'eyeshadow', 'concealer', 'bronzer', 'highlighter'],
  fragrance: ['fragrance', 'perfume', 'eau de parfum', 'cologne', 'body mist', 'scent', 'aroma', 'musk', 'floral', 'oud'],
  'home-decor': ['decor', 'vase', 'candle', 'art', 'sculpture', 'frame', 'mirror', 'rug', 'throw', 'cushion', 'pillow', 'bowl', 'tray', 'ornament'],
  furniture: ['furniture', 'chair', 'sofa', 'table', 'lamp', 'shelf', 'desk', 'bench', 'stool', 'cabinet', 'dresser', 'bed', 'armchair'],
  'tech-devices': ['headphone', 'speaker', 'phone', 'laptop', 'wearable', 'device', 'earbuds', 'tablet', 'smart', 'gadget'],
  food: ['meal', 'dish', 'dessert', 'plate', 'breakfast', 'lunch', 'dinner', 'pasta', 'salad'],
  beverages: ['beverage', 'coffee', 'tea', 'wine', 'spirit', 'soft drink', 'juice', 'cocktail', 'mocktail', 'latte', 'espresso', 'matcha', 'smoothie'],
