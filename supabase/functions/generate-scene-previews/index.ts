...
const scenePreviewPrompts: Record<string, string> = {
  ...
  "Golden Hour Selfie": `Photorealistic iPhone front-camera selfie of ${getModelDesc(0)} outdoors during golden hour, warm sunset light on face, soft bokeh background of trees or cityscape, looking directly into camera lens with a natural smile, 26mm focal length, Smart HDR, deep depth of field, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
