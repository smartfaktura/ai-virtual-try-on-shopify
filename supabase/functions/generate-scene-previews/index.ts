...
const scenePreviewPrompts: Record<string, string> = {
  ...
  // Mirror Selfie Set – new scenes (batch 2)
  "Living Room Arch Mirror": `Photorealistic mirror selfie of a young woman standing in front of a large arched decorative floor mirror in a stylish living room, holding smartphone at chest level capturing reflection, warm earth tones, textured area rug, indoor plants, soft afternoon sunlight through large windows, bohemian-modern interior, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Entryway Console": `Photorealistic mirror selfie of a young woman standing in front of a round or full-length mirror above a console table in a modern entryway foyer, holding smartphone capturing reflection, coat hooks and bags visible, warm pendant light overhead, clean minimalist decor, welcoming transitional space, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Dance Studio": `Photorealistic mirror selfie of a young woman in a dance studio standing in front of a full-length wall-to-wall mirror, holding smartphone capturing reflection, wooden barre along the wall, sprung hardwood flooring, bright natural light from large windows, clean airy professional dance space, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Restaurant Restroom": `Photorealistic mirror selfie of a young woman in a sleek modern restaurant restroom standing in front of a large mirror, holding smartphone capturing reflection, moody ambient lighting with warm sconces, dark marble walls, designer faucets, sophisticated nightlife aesthetic, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Luxury Dressing Room": `Photorealistic mirror selfie of a young woman in a high-end department store dressing room standing in front of an ornate gold-framed mirror, holding smartphone capturing reflection, velvet curtains, warm spotlights, plush carpet, premium luxury retail aesthetic, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Sunlit Loft": `Photorealistic mirror selfie of a young woman in a large industrial loft standing in front of a full-length mirror leaning against an exposed brick wall, holding smartphone capturing reflection, floor-to-ceiling windows with warm morning sunlight streaming in, polished concrete floors, plants, urban creative lifestyle, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Shopping Mall": `Photorealistic mirror selfie of a young woman reflected in a large mirror or reflective glass in a bright modern shopping mall corridor, holding smartphone capturing reflection, polished marble floors, high ceilings, retail storefronts visible in background, upscale shopping aesthetic, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
  "Beach House": `Photorealistic mirror selfie of a young woman standing in front of a full-length mirror in a bright beach house, holding smartphone capturing reflection, white-washed wood walls, rattan furniture, ocean light through sheer linen curtains, relaxed coastal vacation lifestyle, iPhone quality, Instagram aesthetic, 4:5 portrait, ${MASTER_SUFFIX}`,
};
