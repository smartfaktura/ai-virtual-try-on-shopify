...
const scenePreviewPrompts: Record<string, string> = {
  ...
  // Selfie / UGC Set scenes — iPhone front-camera POV, no phone visible, 9:16 vertical
  "Golden Hour Selfie": `Photorealistic iPhone front-camera selfie of ${getModelDesc(0)} outdoors during golden hour, warm sunset light on face, trees or cityscape visible in the distance, looking directly into camera lens with a natural smile, 26mm focal length, Smart HDR, deep depth of field, everything in sharp focus, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Coffee Shop / Brunch": `Photorealistic iPhone front-camera selfie of ${getModelDesc(1)} sitting at a cozy coffee shop table, latte and pastry on table, warm interior lighting, exposed brick or plants in background, looking directly into camera lens, casual brunch vibe, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Car Selfie": `Photorealistic iPhone front-camera selfie of ${getModelDesc(2)} sitting in the driver's seat of a modern car, natural daylight through windshield, steering wheel partially visible, seatbelt on, relaxed expression looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Walking Street Style": `Photorealistic iPhone front-camera selfie of ${getModelDesc(3)} walking on a stylish urban street, city architecture in background, natural daylight, motion energy, confident expression looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Gym / Workout": `Photorealistic iPhone front-camera selfie of ${getModelDesc(4)} in athletic wear at a modern gym, exercise equipment in soft background, overhead LED lighting, post-workout glow, energetic expression looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Morning Routine / GRWM": `Photorealistic iPhone front-camera selfie of ${getModelDesc(5)} in a bright bathroom doing morning routine, vanity with skincare products visible, soft natural morning light, dewy fresh skin, looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC GRWM aesthetic, ${MASTER_SUFFIX}`,
  "Bedroom Outfit Check": `Photorealistic iPhone front-camera selfie of ${getModelDesc(0)} standing in a cozy bedroom, bed and pillows in soft background, warm natural daylight through curtains, showing off outfit from chest up, confident expression looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Couch / Netflix Chill": `Photorealistic iPhone front-camera selfie of ${getModelDesc(1)} lounging on a stylish sofa, cozy blanket and cushions, warm ambient lamp lighting, relaxed lazy-day expression looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC cozy aesthetic, ${MASTER_SUFFIX}`,
  "Kitchen Counter": `Photorealistic iPhone front-camera selfie of ${getModelDesc(2)} in a modern kitchen, marble countertop and kitchen appliances in background, bright natural window light, casual at-home vibe, looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC aesthetic, ${MASTER_SUFFIX}`,
  "Unboxing Excitement": `Photorealistic iPhone front-camera selfie of ${getModelDesc(3)} with an excited surprised expression, open shipping box and tissue paper on table nearby, bright overhead lighting, genuine delight reaction looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC unboxing aesthetic, ${MASTER_SUFFIX}`,
  "Haul / You Need This": `Photorealistic iPhone front-camera selfie of ${getModelDesc(4)} with enthusiastic expression, shopping bags on bed or table behind them, warm bedroom or living room setting, animated talking-to-camera energy looking directly into lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC haul aesthetic, ${MASTER_SUFFIX}`,
  "Before / After Moment": `Photorealistic iPhone front-camera selfie of ${getModelDesc(5)} with a confident 'reveal' expression, clean neutral background, bright even lighting, direct eye contact into camera lens, testimonial energy, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC before-after aesthetic, ${MASTER_SUFFIX}`,
  "POV Discovery": `Photorealistic iPhone front-camera selfie of ${getModelDesc(0)} with wide-eyed curious discovery expression, holding or gesturing toward something off-camera, lifestyle setting with natural light, looking into camera lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC POV aesthetic, ${MASTER_SUFFIX}`,
  "Testimonial / Review": `Photorealistic iPhone front-camera selfie of ${getModelDesc(1)} with sincere genuine expression, clean minimal background, soft natural lighting, speaking-to-camera energy with direct eye contact into lens, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC review aesthetic, ${MASTER_SUFFIX}`,
  "In-Use Close-up": `Photorealistic iPhone front-camera close-up selfie of ${getModelDesc(2)} face and upper chest, applying or demonstrating a product near face, soft natural lighting, focused expression looking into camera lens, tight framing, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC close-up aesthetic, ${MASTER_SUFFIX}`,
  "Hands-Only Demo": `Photorealistic iPhone top-down close-up of well-manicured hands demonstrating a product on a clean styled surface, soft natural lighting, no face visible, product-focused POV shot, 26mm focal length, Smart HDR, no phone visible, 9:16 vertical, Instagram UGC hands-only aesthetic, ${MASTER_SUFFIX}`,
  // Interior Design Styles
  "Modern Minimalist": `Beautiful modern minimalist living room interior, clean geometric lines, neutral palette of whites grays and blacks, sleek low-profile sofa, minimal accessories, large windows with natural light, polished concrete or light wood floor, ${MASTER_SUFFIX}`,
  "Scandinavian": `Beautiful Scandinavian style living room, light oak wood furniture, white walls, cozy wool throw on linen sofa, hygge atmosphere, soft ambient lighting, muted pastel accents, indoor plant, ${MASTER_SUFFIX}`,
  "Japandi": `Beautiful Japandi fusion living room, wabi-sabi aesthetic, natural wood and stone materials, earth tones, low-profile platform sofa, bamboo accent, paper lantern, minimal clutter, indoor bonsai, ${MASTER_SUFFIX}`,
  "Mid-Century Modern": `Beautiful mid-century modern living room, iconic tapered-leg furniture, warm walnut tones, mustard yellow accent chair, teal throw pillow, statement arc floor lamp, clean functional 1960s design, ${MASTER_SUFFIX}`,
  "Industrial": `Beautiful industrial style loft living room, exposed brick wall, raw metal shelving, dark moody tones, Edison bulb pendant lights, leather sofa, reclaimed wood coffee table, ${MASTER_SUFFIX}`,
  "Bohemian": `Beautiful bohemian living room, layered Moroccan textiles and patterns, abundant indoor plants, warm earthy tones with pops of color, rattan peacock chair, macramé wall hanging, floor cushions, ${MASTER_SUFFIX}`,
  "Coastal / Hampton": `Beautiful coastal Hampton style living room, light blue and white palette, sandy neutral linen sofa, jute area rug, weathered wood coffee table, nautical accents, airy breezy atmosphere, ${MASTER_SUFFIX}`,
  "Traditional / Classic": `Beautiful traditional classic living room, elegant velvet sofa, rich mahogany wood, symmetrical arrangement, crystal chandelier, damask curtains, crown molding, layered window treatments, ${MASTER_SUFFIX}`,
  "Farmhouse / Rustic": `Beautiful farmhouse rustic living room, reclaimed wood beams, distressed white shiplap wall, cream and sage palette, overstuffed linen sofa, woven baskets, mason jar vase with wildflowers, ${MASTER_SUFFIX}`,
  "Contemporary Luxury": `Beautiful contemporary luxury living room, marble accent wall, brass and gold fixtures, designer sculptural furniture, refined cashmere throws, statement art piece, polished surfaces, ${MASTER_SUFFIX}`,
  "Art Deco": `Beautiful Art Deco living room, geometric sunburst mirror, emerald green velvet sofa, gold lacquered surfaces, jewel tones, crystal wall sconces, opulent theatrical glamour, ${MASTER_SUFFIX}`,
  "Mediterranean": `Beautiful Mediterranean style living room, terracotta warm earth tones, wrought iron accents, mosaic tile coffee table, olive pottery, rustic wood beams, textured plaster walls, ${MASTER_SUFFIX}`,
  // Exterior Design Styles
  "Mediterranean Villa": `Beautiful Mediterranean villa exterior, terracotta roof tiles, warm sandstone facade, wrought iron railings, olive trees and lavender borders, stone pathway, arched pergola, warm golden hour light, ${MASTER_SUFFIX}`,
  "Tropical Resort": `Beautiful tropical resort exterior, lush palm trees and tropical plants, teak outdoor furniture with vibrant cushions, infinity pool edge, thatched roof accent, warm golden lighting, ${MASTER_SUFFIX}`,
  "Modern Architectural": `Beautiful modern architectural home exterior, clean geometric facade, concrete and glass, minimalist outdoor furniture, architectural lighting, neutral tones, manicured landscaping, ${MASTER_SUFFIX}`,
  "English Cottage Garden": `Beautiful English cottage garden exterior, overflowing flower beds with roses and lavender, stone pathway, weathered wooden bench, white picket fence, cottage lanterns, lush green lawn, ${MASTER_SUFFIX}`,
  "Desert Southwest": `Beautiful desert southwest home exterior, adobe walls, drought-resistant cacti and succulents, sandstone pavers, warm terracotta tones, shade pergola, warm evening desert light, ${MASTER_SUFFIX}`,
  "Coastal Beach House": `Beautiful coastal beach house exterior, whitewashed wood siding, nautical blue shutters, rope railings, sea grass plantings, weathered teak deck furniture, ocean breeze atmosphere, ${MASTER_SUFFIX}`,
  "Japanese Zen Garden": `Beautiful Japanese zen garden exterior, raked white gravel, moss-covered stepping stones, bamboo fence, stone lantern, bonsai trees, small water feature, wooden deck, tranquil atmosphere, ${MASTER_SUFFIX}`,
  "Rustic Mountain Lodge": `Beautiful rustic mountain lodge exterior, natural stone and timber facade, Adirondack chairs on porch, stone fire pit, pine trees, lantern path lighting, warm mountain retreat atmosphere, ${MASTER_SUFFIX}`,
  "Contemporary Urban": `Beautiful contemporary urban rooftop terrace, modular outdoor sectional, concrete planters with ornamental grasses, string lights overhead, sleek privacy screens, city skyline backdrop, ${MASTER_SUFFIX}`,
  "French Country Estate": `Beautiful French country estate exterior, lavender borders along gravel courtyard, stone walls, wrought iron garden furniture, classic topiary urns, climbing wisteria on facade, warm provincial charm, ${MASTER_SUFFIX}`,
};
