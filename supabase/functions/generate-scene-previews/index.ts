...
const scenePreviewPrompts: Record<string, string> = {
  ...
  "Bathroom Vanity": `Photorealistic mirror selfie of ${getModelDesc(1)} in front of a large bathroom vanity mirror, holding smartphone capturing reflection, warm overhead vanity lighting, marble countertop and subway tile walls visible, sleek modern bathroom, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Boutique Fitting Room": `Photorealistic mirror selfie of ${getModelDesc(2)} in a boutique fitting room, standing in front of a full-length mirror, holding smartphone at chest level, bright even flattering retail lighting, clean neutral walls, professional retail environment, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Elevator / Lobby": `Photorealistic mirror selfie of ${getModelDesc(3)} reflected in polished elevator doors in a modern building lobby, holding smartphone capturing reflection, moody ambient lighting with warm elevator ceiling lights, polished metal and marble surfaces, urban sophisticated aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Gym Mirror": `Photorealistic mirror selfie of ${getModelDesc(4)} in athletic wear standing in front of a gym wall mirror, holding smartphone capturing reflection, bright overhead LED lights, gym equipment subtly visible in background, rubber flooring, energetic fitness atmosphere, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Hotel Room": `Photorealistic mirror selfie of ${getModelDesc(5)} in a luxury hotel room standing in front of a full-length mirror, holding smartphone capturing reflection, warm ambient lighting from bedside lamps, elegant decor with plush bedding visible, travel lifestyle aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  ...
  "Minimalist Hallway": `Photorealistic mirror selfie of ${getModelDesc(1)} standing in front of a tall standing mirror in a clean minimalist hallway, holding smartphone capturing reflection, natural light from nearby window, hardwood floors, white walls with minimal decor, Scandinavian aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Coffee Shop Window": `Photorealistic mirror selfie of ${getModelDesc(2)} reflected in a coffee shop window from inside, holding smartphone capturing reflection, warm interior with exposed brick, coffee cup on table nearby, cozy urban cafe atmosphere, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Car Side Mirror": `Photorealistic mirror selfie of ${getModelDesc(3)} visible in a car side mirror or window reflection, holding smartphone capturing reflection, outdoor scenery behind, natural daylight, casual spontaneous vibe, urban on-the-go aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Rooftop Terrace": `Photorealistic mirror selfie of ${getModelDesc(4)} reflected in a glass door on a rooftop terrace, holding smartphone capturing reflection, city skyline visible behind, golden hour lighting, potted plants and outdoor furniture nearby, aspirational urban lifestyle, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  ...
  "Art Gallery": `Photorealistic mirror selfie of ${getModelDesc(0)} standing in front of a large mirror in a contemporary art gallery, holding smartphone capturing reflection, clean white walls, professional gallery track lighting, polished floors, sophisticated cultural aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Hair Salon": `Photorealistic mirror selfie of ${getModelDesc(1)} sitting at a salon mirror with styling station visible, holding smartphone capturing reflection, professional ring lights or vanity bulbs around mirror frame, hair products on counter, flattering beauty lighting, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Vintage Shop": `Photorealistic mirror selfie of ${getModelDesc(2)} standing in front of an ornate antique mirror in a vintage thrift shop, holding smartphone capturing reflection, eclectic decor with vintage clothing racks, warm Edison bulb lighting, nostalgic treasure-hunt atmosphere, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Studio Apartment": `Photorealistic mirror selfie of ${getModelDesc(3)} standing in front of a full-length mirror in a cozy studio apartment, holding smartphone capturing reflection, warm window light streaming in, plant on windowsill, books stacked nearby, intimate authentic living space aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,

  // Mirror Selfie Set – batch 2
  "Living Room Arch Mirror": `Photorealistic mirror selfie of ${getModelDesc(4)} standing in front of a large arched decorative floor mirror in a stylish living room, holding smartphone at chest level capturing reflection, warm earth tones, textured area rug, indoor plants, soft afternoon sunlight through large windows, bohemian-modern interior, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Entryway Console": `Photorealistic mirror selfie of ${getModelDesc(5)} standing in front of a round or full-length mirror above a console table in a modern entryway foyer, holding smartphone capturing reflection, coat hooks and bags visible, warm pendant light overhead, clean minimalist decor, welcoming transitional space, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Dance Studio": `Photorealistic mirror selfie of ${getModelDesc(0)} in a dance studio standing in front of a full-length wall-to-wall mirror, holding smartphone capturing reflection, wooden barre along the wall, sprung hardwood flooring, bright natural light from large windows, clean airy professional dance space, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Restaurant Restroom": `Photorealistic mirror selfie of ${getModelDesc(1)} in a sleek modern restaurant restroom standing in front of a large mirror, holding smartphone capturing reflection, moody ambient lighting with warm sconces, dark marble walls, designer faucets, sophisticated nightlife aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Luxury Dressing Room": `Photorealistic mirror selfie of ${getModelDesc(2)} in a high-end department store dressing room standing in front of an ornate gold-framed mirror, holding smartphone capturing reflection, velvet curtains, warm spotlights, plush carpet, premium luxury retail aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Sunlit Loft": `Photorealistic mirror selfie of ${getModelDesc(3)} in a large industrial loft standing in front of a full-length mirror leaning against an exposed brick wall, holding smartphone capturing reflection, floor-to-ceiling windows with warm morning sunlight streaming in, polished concrete floors, plants, urban creative lifestyle, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Shopping Mall": `Photorealistic mirror selfie of ${getModelDesc(4)} reflected in a large mirror or reflective glass in a bright modern shopping mall corridor, holding smartphone capturing reflection, polished marble floors, high ceilings, retail storefronts visible in background, upscale shopping aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Beach House": `Photorealistic mirror selfie of ${getModelDesc(5)} standing in front of a full-length mirror in a bright beach house, holding smartphone capturing reflection, white-washed wood walls, rattan furniture, ocean light through sheer linen curtains, relaxed coastal vacation lifestyle, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,

  // Mirror Selfie Set – batch 3: Fitness
  "Pilates Studio": `Photorealistic mirror selfie of ${getModelDesc(0)} in sleek activewear standing in front of a full-length mirror in a bright Pilates reformer studio, holding smartphone at waist level capturing reflection, natural wood Pilates reformers visible, bright clean space with light wood floors, large windows with natural light, wellness aesthetic, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Yoga Studio": `Photorealistic mirror selfie of ${getModelDesc(1)} in yoga attire standing in front of a wall mirror in a serene yoga studio, holding smartphone capturing reflection, bamboo floors, warm ambient lighting, lush green plants, rolled yoga mats nearby, peaceful zen atmosphere, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Gym Locker Room": `Photorealistic mirror selfie of ${getModelDesc(2)} in athletic wear standing in front of a full-length mirror in a modern gym locker room, holding smartphone capturing reflection, clean tiled walls, bright overhead lighting, sleek lockers visible, post-workout casual vibe, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,

  // Mirror Selfie Set – batch 3: Hotel Lobby
  "Hotel Lobby Grand": `Photorealistic mirror selfie of ${getModelDesc(3)} in an elegant outfit standing in front of an ornate full-length mirror in a grand hotel lobby, holding smartphone capturing reflection, marble floors, crystal chandelier overhead, luxury gold accents, opulent classic architecture, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Hotel Lobby Modern": `Photorealistic mirror selfie of ${getModelDesc(4)} in a chic outfit standing near sleek reflective glass in a contemporary boutique hotel lobby, holding smartphone capturing reflection, modern designer furniture, moody atmospheric lighting, dark tones with warm accent lights, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
  "Hotel Lobby Boutique": `Photorealistic mirror selfie of ${getModelDesc(5)} standing in front of a decorative mirror in a boutique hotel entrance, holding smartphone capturing reflection, lush indoor plants, warm earthy tones, eclectic vintage-modern decor, textured walls, welcoming intimate atmosphere, iPhone quality, Instagram aesthetic, ${MIRROR_FORMAT}, ${MASTER_SUFFIX}`,
};
