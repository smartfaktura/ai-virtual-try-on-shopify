...
BEGIN
  ...
  -- Burst rate limit: max jobs per 60 seconds
  ...
  -- REMOVED: concurrent processing check
  -- Jobs queue freely as "queued" status; process-queue controls concurrency
  -- by only claiming and dispatching a limited number at a time.
