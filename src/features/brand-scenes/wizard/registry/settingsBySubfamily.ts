...
const POOLS: Record<string, Pool> = {
  ...
  "fashion/lingerie": {
    indoor_lifestyle: [
      ...
      "Loft bedroom by window",
      "Silk-curtain bay",
      "Quiet hallway with sheers",
      "Powder room corner",
    ...
    studio: [
      "Soft silk drape",
      "Painted plaster wall",
      "Cyclorama soft sweep",
      "Pleated paper backdrop",
      "Floating tulle veil",
      "Hard-light split studio",
    ],
    architectural: [
      "Marble bathhouse",
      "Stone cloister",
      "Brutalist concrete bedroom",
      "Glass atrium banquette",
    ],
  },
  "fashion/streetwear": {
  ...
  "fashion/socks": {
    studio: ["Cyclorama", "Plinth on cyclorama", "Folded flat on paper", "Folded pair on linen", "Stacked on wood", "Drawer flat lay"],
