    ...
    <div className="space-y-12">
      ...
      {hasSceneType && (
        <>
          ...
          <div>
            <ChapterHeading>Mood & atmosphere</ChapterHeading>
            <div className="space-y-10">
          ...
          <div>
            <ChapterHeading>Fine-tuning</ChapterHeading>
            <div className="space-y-10">
              {(() => {
                const ctx: SceneCtx = {
                  module,
                ...
                const ordered = [
                  ...fields
                    .filter((f) => ENV_FIELD_ORDER.includes(f.key))
                    .sort(
                      (a, b) =>
                        ENV_FIELD_ORDER.indexOf(a.key) -
                        ENV_FIELD_ORDER.indexOf(b.key),
                    ),
                  ...fields.filter((f) => !ENV_FIELD_ORDER.includes(f.key)),
                ];
