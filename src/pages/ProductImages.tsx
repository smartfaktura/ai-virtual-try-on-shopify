...
export default function ProductImages() {
  ...
  const stepHeader = (() => {
    switch (step) {
      ...
      case 4: return { title: 'Review & generate', subtitle: 'Check everything and start creating your visuals' };
      default: return null;
    }
  })();
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      {/* Analyzing placeholders — match regular product card sizing exactly */}
                      {analyzingCards.map(card => (
                        ...
                        >
                          ...
                          <div className="h-[44px] px-1.5 py-1 bg-card flex flex-col justify-center">
                            <p className="text-[10px] font-medium text-foreground leading-tight line-clamp-1">Analyzing…</p>
              ...
              {isFree && userProducts.length >= 2 && (
                <div className="flex items-center gap-3 px-5 py-2.5 rounded-full bg-muted/40 border border-border text-xs">
                  ...
                  <span className="text-muted-foreground">
                    <span>Free plan: select only 1 product. Upgrade to select multiple products.</span>
                  </span>
                  <button
