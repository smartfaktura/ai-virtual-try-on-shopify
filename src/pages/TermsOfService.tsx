      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground [&_h2]:text-foreground [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-foreground [&_h3]:font-medium [&_h3]:mt-6 [&_h3]:mb-2 [&_p]:mb-4 [&_p]:leading-relaxed [&_ul]:mb-4 [&_ul]:space-y-1 [&_li]:ml-4">
            ...
            <h2>1. Definitions</h2>
            <p>In these Terms of Service ("Terms"), the following definitions apply:</p>
            <ul>
              <li>• <strong>"Service"</strong> — the VOVV.AI platform, including all web applications, APIs, and related tools operated by VOVV.AI.</li>
              <li>• <strong>"Inputs"</strong> — all content you upload to the Service, including product images, reference photos, model photos, background images, text prompts, and any other materials.</li>
              <li>• <strong>"Generations"</strong> — all images, videos, and other content produced by the Service based on your Inputs and selections.</li>
              <li>• <strong>"Credits"</strong> — the unit of currency used to access generation features within the Service, allocated per your subscription plan or purchased separately.</li>
              <li>• <strong>"Account Data"</strong> — your registration information, preferences, usage history, and other non-content data associated with your account.</li>
              <li>• <strong>"Confidential Information"</strong> — any non-public information disclosed by either party in connection with the Service, including product imagery, brand assets, business strategies, and proprietary workflows.</li>
            </ul>

            <h2>2. Acceptance of Terms</h2>
            <p>
              By accessing or using the Service, you agree to be bound by these Terms. If you do not agree, do not use the Service. These Terms constitute a legally binding agreement between you and VOVV.AI.
            </p>

            <h2>3. Eligibility and Age Restriction</h2>
            <p>
              You must be at least 16 years of age to use the Service. If you are located in a jurisdiction where the minimum age for using online services is higher, you must meet that minimum age. By using the Service, you represent and warrant that you meet the applicable age requirement. If you are between 16 and 18 years of age (or the age of majority in your jurisdiction), you may only use the Service with the consent of a parent or legal guardian who agrees to be bound by these Terms.
            </p>
            ...
            <h2>5. Service Description and Availability</h2>
            <p>
              VOVV.AI provides AI-powered product photography generation tools. You upload Inputs, and our Service generates styled product photographs, lifestyle images, on-model shots, and videos based on your selections.
            </p>
            <p>
              <strong>VOVV.AI is a tool provider only.</strong> We provide automated generation tools and do not exercise editorial control over the content you create. We have no obligation to review, monitor, screen, or approve any content you upload or any outputs generated through the Service.
            </p>
            <h3>Service Availability</h3>
            <p>
              We strive to maintain high availability of the Service but do not guarantee uninterrupted access. The Service may be subject to scheduled maintenance, updates, or modifications. We will make reasonable efforts to provide advance notice of planned downtime. You should not create critical business dependencies on specific Service features, as features may be modified, deprecated, or removed.
            </p>

            <h2>6. Credits and Payment</h2>
            <p>
            ...
            <h2>8. Your Uploads — Representations and Warranties</h2>
            <p>
            ...
            <h2>9. Your Responsibility for Generated Content</h2>
            <p>
              <strong>You are solely and exclusively responsible for ALL Generations,</strong> including but not limited to:
            </p>
            <ul>
            ...
            <h3>Your Content</h3>
            <p>
              You retain all rights to the Inputs you upload. By uploading Inputs, you grant us a limited, non-exclusive license to process them solely for providing the Service. This license terminates when you delete your account or the relevant content.
            </p>
            <h3>Generated Content Ownership</h3>
            <p>
              Subject to your compliance with these Terms and your subscription plan, you own the Generations created through your use of the Service. However, see Section 11 regarding the intellectual property status of AI-generated content.
            </p>
            <h3>Our Property</h3>
            <p>
            ...
            <h2>11. Intellectual Property Status of AI-Generated Content</h2>
            <p>
            ...
            <h2>12. Third-Party Service Providers</h2>
            <p>
              The Service relies on third-party infrastructure and technology providers, including but not limited to cloud hosting services, AI model providers, payment processors, and analytics tools. These providers may process your data in accordance with their own terms and privacy policies. By using the Service, you acknowledge and consent to such third-party processing.
            </p>
            <p>
              VOVV.AI is not responsible for the acts or omissions of third-party providers. We select our providers with care and require them to maintain appropriate security and confidentiality standards, but we cannot guarantee their performance or availability.
            </p>
            ...
            <ul>
              ...
              <li>• Information that was already known to the receiving party prior to disclosure</li>
              <li>• Information that is independently developed without reference to the disclosing party's Confidential Information</li>
              <li>• Information required to be disclosed by law, regulation, or court order (with prompt notice to the disclosing party where legally permitted)</li>
            </ul>
            <p>
              Your Inputs and Generations are treated as your Confidential Information. We will not share, publish, or use your Inputs or Generations except as necessary to provide the Service. This confidentiality obligation survives termination of these Terms for a period of three (3) years.
            </p>
            ...
            <ul>
              ...
              <li>• Any Inputs you upload to the Service</li>
              ...
              <li>• Any claim by a third party related to your Inputs or Generations</li>
            </ul>
            <p>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL VOVV.AI, ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, OR AFFILIATES BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, BUSINESS OPPORTUNITIES, GOODWILL, OR REPUTATION, ARISING FROM YOUR USE OF THE SERVICE, YOUR GENERATIONS, OR ANY INPUTS UPLOADED TO THE SERVICE.
            </p>
            <p>
            ...
            <h2>17. DMCA and Copyright Takedowns</h2>
            <p>
            ...
            <p>
              Neither party shall be liable for any failure or delay in performing its obligations under these Terms where such failure or delay results from circumstances beyond the reasonable control of the affected party, including but not limited to: acts of God, natural disasters, war, terrorism, riots, embargoes, acts of government authorities, power failures, internet or telecommunications outages, cyberattacks, pandemics, or epidemics.
            </p>
            <p>
              The affected party shall promptly notify the other party and make reasonable efforts to mitigate the impact. If a force majeure event continues for more than ninety (90) days, either party may terminate these Terms upon written notice.
            </p>

            <h2>19. Termination</h2>
            <p>
              You may terminate your account at any time through the Settings page. We may suspend or terminate your access immediately and without prior notice if you violate these Terms, engage in conduct that we determine is harmful to the Service or other users, or if we are required to do so by law. Upon termination, your right to use the Service ceases immediately. Sections 1, 8, 9, 11, 13, 14, 15, 16, and 21 shall survive termination.
            </p>

            <h2>20. Electronic Communications</h2>
            <p>
              By using the Service, you consent to receiving electronic communications from us, including account notifications, service updates, and legal notices. You agree that all agreements, notices, and other communications provided electronically satisfy any legal requirement that such communications be in writing. Electronic records and documents exchanged in connection with these Terms shall have the same legal validity as their physical equivalents.
            </p>
