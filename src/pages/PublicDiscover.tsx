...
export default function PublicDiscover() {
  ...
  const { user } = useAuth();
  const { data: presets = [], isLoading: isLoadingPresets } = useDiscoverPresets();
  ...
  return (
    <PageLayout>
      <SEOHead title="Explore AI Product Photography — VOVV.AI" description="All images on this page were generated with VOVV.AI. Explore AI fashion photography styles, scenes and prompts — start generating for free." canonical={`${SITE_URL}/discover`} noindex={!!urlItemId} />
