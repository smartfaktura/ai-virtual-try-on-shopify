                  ...
                  {(selectedProduct || scratchUpload) && (
                    <div className="flex-shrink-0 text-center">
                      <div className="w-12 h-12 rounded-lg overflow-hidden border border-border bg-muted/30">
                        <img
                          src={sourceType === 'scratch' ? scratchUpload?.previewUrl : selectedProduct?.images[0]?.url || '/placeholder.svg'}
                          alt="Product"
                          className="w-full h-full object-cover"
                        />
                      </div>
                      <p className="text-[10px] text-muted-foreground mt-1 max-w-[64px] truncate">
                        {sourceType === 'scratch' ? scratchUpload?.productInfo.title : selectedProduct?.title}
                      </p>
                    </div>
                  )}
                  {selectedModel && (
