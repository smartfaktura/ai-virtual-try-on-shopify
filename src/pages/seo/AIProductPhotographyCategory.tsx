...
import { CategoryMotionShowcase } from '@/components/seo/photography/category/CategoryMotionShowcase';
...
export default function AIProductPhotographyCategory() {
  ...
  const hidePainAndUseCases = ['bags', 'swimwear', 'activewear', 'eyewear', 'hoodies', 'wedding-dresses'].includes(page.slug);
