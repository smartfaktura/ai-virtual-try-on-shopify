...
// Interleaved with visual contrast — Essentials sprinkled evenly, editorials reshuffled
// so adjacent cards alternate between portrait, full-body, location, and detail shots.
const IMAGES: Img[] = [
