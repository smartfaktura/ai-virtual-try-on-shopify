...
export default function Freestyle() {
  ...
  return (
    <div className="freestyle-root relative -mx-4 sm:-mx-6 lg:-mx-8 -mb-4 sm:-mb-6 lg:-mb-8 lg:-mt-8 bg-muted/30 overflow-hidden" style={{ height: 'calc(100dvh - 5.5rem)', minHeight: '100%' }}>
      ...
      <style>{`@media (max-width: 1023px) { .freestyle-root { margin-top: 0 !important; } }`}</style>
      <input ref={fileInputRef} type="file" accept="image/*" onChange={handleFileSelect} className="hidden" />

      {/* Scrollable content area */}
      <div className="h-full overflow-y-auto pt-20 lg:pt-0 pb-72">
        {showLoading ? (
      ...
      <div className="absolute bottom-0 left-0 right-0 px-3 sm:px-6 pb-3 sm:pb-5 pt-2 pointer-events-none z-20">
