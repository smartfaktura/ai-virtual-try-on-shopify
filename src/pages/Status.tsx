...
export default function Status() {
  ...
  return (
    <PageLayout>
      <SEOHead title="System Status — VOVV AI" description="Real-time status of VOVV AI services including platform, generation API, CDN, authentication, and billing. 99.9% uptime." canonical="https://vovvai.lovable.app/status" />
      {/* Hero */}
