...
export const GLOBAL_SCENES: ProductImageScene[] = [
  ...
  },
  {
    id: 'back-angle',
    title: 'Back Angle',
    description: 'Rear view showing the back of the product for full coverage.',
    chips: ['Back', 'Reverse', '180°'],
  ...
  },
  {
    id: 'side-profile',
    title: 'Side Profile',
    description: 'Left or right side view of the product showing depth and silhouette.',
    chips: ['Side', 'Profile', '3/4'],
    triggerBlocks: ['angleSelection'],
    isGlobal: true,
  },
  {
    id: 'top-down',
    title: 'Top-Down / Bird\'s Eye',
    description: 'Direct overhead view of the product for listings and catalogs.',
    chips: ['Overhead', 'Top', 'Flat'],
    triggerBlocks: ['angleSelection'],
    isGlobal: true,
  },
  {
    id: 'macro-texture',
    title: 'Macro Texture',
    description: 'Extreme close-up showing micro-details, textures, and material quality.',
    chips: ['Texture', 'Macro', 'Material'],
    triggerBlocks: ['detailFocus'],
    isGlobal: true,
  },
  {
    id: 'wide-environment',
    title: 'Wide / Context Shot',
    description: 'Pulled-back shot showing the product in a broader environment.',
    chips: ['Wide', 'Context', 'Environment'],
  ...
  },
  {
    ...
    description: 'Invisible mannequin or floating product effect for clean product-only shots.',
    chips: ['Invisible', 'Clean', 'Product-only'],
    triggerBlocks: ['background'],
    isGlobal: true,
  },
  {
    id: 'on-surface',
    title: 'On Surface',
    description: 'Product placed naturally on a styled surface with subtle shadow.',
    chips: ['Surface', 'Natural', 'Shadow'],
    triggerBlocks: ['sceneEnvironment'],
    isGlobal: true,
  },
];
