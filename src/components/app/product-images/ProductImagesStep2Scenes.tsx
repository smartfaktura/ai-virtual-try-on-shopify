...
import { Check, ChevronDown, ChevronRight, Camera, Copy, AlertCircle, Paintbrush, Sparkles, Info } from 'lucide-react';
...
const SPECIFICITY_OVERRIDES: [string, RegExp, string][] = [
  ...
  ["bags-accessories", /phone case|iphone case|airpods case|samsung case|silicone case|clear case|magsafe case|magsafe/i, "phone-cases"],
...
function SubGroupSection({ label, scenes, selectedSceneIds, toggleScene, gridClass, globalSelectionInfo }: {
  ...
  return (
    <div className="pt-3 pl-2 min-w-0 max-w-full">
      <div className="flex items-center gap-3 mb-3 min-w-0 max-w-full">
