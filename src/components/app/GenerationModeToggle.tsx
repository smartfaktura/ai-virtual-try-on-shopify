...
const modeOptions: ModeOption[] = [
  { id: 'product-only', icon: ImageIcon, title: 'Product Shot', subtitle: 'Focus on the product itself', creditCost: '4-6 credits/image', useCases: ['Detail shots', 'Flat lay', 'Studio backgrounds', 'E-commerce listings'] },
  { id: 'virtual-try-on', icon: User, title: 'Virtual Try-On', subtitle: 'See it on a model', creditCost: '6 credits/image', useCases: ['Lookbooks', 'Social media', 'Lifestyle shots', 'Model photography'], badgeText: 'AI-Powered' },
];
