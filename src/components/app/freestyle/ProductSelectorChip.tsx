...
const SAMPLE_PRODUCTS = [
  { id: 'sample_ring', title: 'Diamond Ring', product_type: 'Jewelry', image_url: '/images/samples/sample-ring.png' },
  { id: 'sample_crop_top', title: 'Ribbed Crop Top', product_type: 'Clothing', image_url: '/images/samples/sample-crop-top.png' },
  { id: 'sample_ice_roller', title: 'Ice Roller', product_type: 'Beauty', image_url: '/images/samples/sample-ice-roller.png' },
] as const;
...
export function ProductSelectorChip({
  selectedProduct, open, onOpenChange, onSelect, products, isLoading, fullWidth,
      ...
      <>
        {isLoading ? (
          ...
          <>
            ...
            <button
              onClick={() => { onOpenChange(false); navigate('/app/products'); }}
              className="mt-3 flex items-center justify-center gap-1 w-full text-xs text-primary hover:underline font-medium py-2 border-t border-border"
            >
