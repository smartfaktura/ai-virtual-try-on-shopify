...
import {
  ...
  TrendingUp, BookOpen, Clock, Camera, GraduationCap, LifeBuoy, Bug, Star, Mail, Mountain,
} from 'lucide-react';
...
const prefetchMap: Record<string, () => void> = {
  ...
  '/app/brand-scenes': () => { import('@/pages/BrandScenes'); },
};
              ...
              <div className={cn(
                ...
                {isRealAdmin && (
                  <>
                    ...
                    <button
                      onClick={() => { navigate('/app/admin/scene-performance'); setUserMenuOpen(false); }}
                      className="w-full px-3 py-2 text-sm text-left hover:bg-muted transition-colors flex items-center gap-2 text-muted-foreground"
                    >
                    ...
                    <button
                      onClick={() => { navigate('/app/admin/email-marketing'); setUserMenuOpen(false); }}
                      className="w-full px-3 py-2 text-sm text-left hover:bg-muted transition-colors flex items-center gap-2 text-muted-foreground"
                    >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                ...
                isEmpty
                  ? 'bg-white border-transparent text-[hsl(var(--sidebar-background))] hover:brightness-95'
                  : isLow
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main id="app-main-scroll" className="flex-1 overflow-y-auto overscroll-contain">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 lg:pt-8 pb-4 sm:pb-6 lg:pb-8">
            {location.pathname !== '/app' && location.pathname !== '/app/' && !location.pathname.startsWith('/app/freestyle') && !location.pathname.startsWith('/app/settings') && !location.pathname.startsWith('/app/pricing') && <LowCreditsBanner />}
            {children}
          </div>
        </main>
      </div>
