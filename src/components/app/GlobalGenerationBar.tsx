...
export function GlobalGenerationBar() {
  ...
  return (
    <div className="fixed bottom-4 right-4 lg:right-6 z-30 pointer-events-none">
      <div className="pointer-events-auto w-72">
        {/* Expanded detail list — renders above the pill */}
        {!minimized && (
          <div className="mb-2 rounded-xl border border-border/60 bg-popover/95 backdrop-blur-xl shadow-xl shadow-black/10 overflow-hidden">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-full border border-border/60 bg-popover/95 backdrop-blur-xl shadow-lg shadow-black/10 hover:bg-muted/50 transition-colors"
        >
          <div className="relative flex items-center justify-center w-6 h-6 rounded-full bg-primary/10 shrink-0">
            {processingJobs > 0 ? (
