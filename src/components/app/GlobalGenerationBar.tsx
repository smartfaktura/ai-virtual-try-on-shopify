            ...
            {visibleActive.length > 0 && (
              <div className="border-t border-border/40 px-3 py-2 flex justify-end">
                {(() => {
                  ...
                  const targetLabel = hasCreativeDrop ? 'View in Content Calendar' : hasUpscale ? 'View in Library' : hasVideo ? 'View in Animate' : hasFreestyle ? 'View in Freestyle' : 'View in Visual Studio';
                  return (
                    <Button
                      size="sm"
                      variant="outline"
