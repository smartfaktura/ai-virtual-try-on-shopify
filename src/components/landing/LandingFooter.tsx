...
const solutionsGroups: FooterGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Beauty & Skincare Product Photography', to: '/ai-product-photography/beauty-skincare' },
      { label: 'Fragrance Product Photography', to: '/ai-product-photography/fragrance' },
      { label: 'Jewelry Product Photography', to: '/ai-product-photography/jewelry' },
      { label: 'Food & Beverage Product Photography', to: '/ai-product-photography/food-beverage' },
      { label: 'Home & Furniture Product Photography', to: '/ai-product-photography/home-furniture' },
      { label: 'Electronics & Gadgets Product Photography', to: '/ai-product-photography/electronics-gadgets' },
      { label: 'Bags Product Photography', to: '/ai-product-photography/bags' },
      { label: 'Watches Product Photography', to: '/ai-product-photography/watches' },
      { label: 'Hoodies Product Photography', to: '/ai-product-photography/hoodies' },
      { label: 'Swimwear Product Photography', to: '/ai-product-photography/swimwear' },
      { label: 'Lingerie Product Photography', to: '/ai-product-photography/lingerie' },
      { label: 'Eyewear Product Photography', to: '/ai-product-photography/eyewear' },
