...
const drops = [
  {
    ...
    thumbnails: [
      s('drops/drop-nov-portrait-1.jpg'),
      s('drops/drop-nov-portrait-2.jpg'),
      s('drops/drop-nov-portrait-3.jpg'),
    ],
    overflow: 13,
    opacity: 'opacity-100',
    status: 'Delivered',
  },
  {
    ...
    thumbnails: [
      s('drops/drop-sept-portrait-1.jpg'),
      s('drops/drop-sept-portrait-2.jpg'),
      s('drops/drop-sept-portrait-3.jpg'),
    ],
    overflow: 17,
    opacity: 'opacity-80',
    status: 'Delivered',
  },
  {
    ...
    thumbnails: [
      s('drops/drop-june-portrait-1.jpg'),
      s('drops/drop-june-portrait-2.jpg'),
      s('drops/drop-june-portrait-3.jpg'),
    ],
    overflow: 17,
    opacity: 'opacity-60',
    status: 'Delivered',
