...
const DETECTION_RULES: [string[], TemplateCategory][] = [
  ...
  [['baseball cap', 'snapback', 'trucker cap', 'visor cap', 'dad hat', 'fitted cap', 'five panel'], 'caps' as TemplateCategory],
  ...
  // Socks before generic shoes/garments
  [['sock', 'socks', 'crew sock', 'ankle sock', 'no-show sock', 'knee-high sock', 'tube sock', 'athletic sock', 'dress sock', 'wool sock', 'compression sock'], 'socks' as TemplateCategory],
