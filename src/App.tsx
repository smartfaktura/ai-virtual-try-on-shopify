...
const SixOApparelShowcase = lazy(() => import('@/pages/showcase/SixOApparelShowcase'));
...
const TalkingVideo = lazy(() => import('@/pages/video/TalkingVideo'));
    ...
    <AuthProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/showcase/6o-apparel" element={<SixOApparelShowcase />} />
                  ...
                  <CreditProvider>
                    <AppShell>
                      ...
                      <Routes>
                        ...
                        <Route path="/video/talking" element={<TalkingVideo />} />
