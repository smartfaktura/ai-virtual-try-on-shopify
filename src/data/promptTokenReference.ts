...
export const TOKEN_GROUPS: TokenGroup[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: 'metalTone', desc: 'Metal tone if applicable', example: 'rose gold', usage: 'EDITORIAL in {{metalTone}}, warm and luxurious' },
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: 'hardwareType', desc: 'EDITORIAL type', example: 'turn-lock clasp', usage: 'Macro of the {{hardwareType}}, precision engineering' },
      { name: 'hardwareFinish', desc: 'EDITORIAL finish', example: 'brushed gold', usage: 'The {{hardwareFinish}} hardware catching warm light' },
