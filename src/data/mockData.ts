...
export const mockTryOnPoses: TryOnPose[] = [
  ...
  { poseId: 'scene_038', name: 'White Studio', category: 'clean-studio', description: 'Clean white studio with soft even lighting, hero product presentation', promptHint: 'Clean white studio environment with soft even lighting, hero product presentation, premium commercial photography', previewUrl: sceneWhiteStudio },
