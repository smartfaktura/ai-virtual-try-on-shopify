...
const showcaseFoodBreadBakery = getLandingAssetUrl('showcase/food-bread-countertop.png');
...
const sceneWhiteStudio = getLandingAssetUrl('scenes/scene-white-studio.png');
...
export const mockModels: ModelProfile[] = [
  ...
  { modelId: 'model_060', name: 'Valeria', gender: 'female', bodyType: 'slim', ethnicity: 'Latina American', ageRange: 'young-adult', previewUrl: modelFemaleSlimAmericanLatina },
  ...
  // ROW_2 sequence — remaining models, W-M alternating
...
export const mockTryOnPoses: TryOnPose[] = [
  ...
  { poseId: 'scene_038', name: 'White Studio', category: 'clean-studio', description: 'Clean white studio with soft even lighting, hero product presentation', promptHint: 'Pure clean white background, seamless white infinity backdrop, bright even studio lighting, no environment, no room, no walls visible, no props, no shadows except subtle product shadow, isolated product on solid white, e-commerce hero shot style', previewUrl: sceneWhiteStudio },
  ...
  // Transferred from Workflows – Product Listing Set
  { poseId: 'scene_032', name: 'Raw Concrete', category: 'clean-studio', description: 'Raw industrial concrete surface with rugged texture', promptHint: 'Raw industrial concrete surface with rugged texture, strong and industrial mood, premium product photography', previewUrl: sceneRawConcrete },
