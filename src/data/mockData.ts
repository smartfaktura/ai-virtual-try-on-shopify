...
export const mockTryOnPoses: TryOnPose[] = [
  ...
  // Studio Category (+3)
  {
    ...
    category: 'studio',
    description: 'Model with back to camera, looking over one shoulder, shoulders slightly angled to show garment rear details, clean studio backdrop',
  ...
  },
  {
    ...
    category: 'studio',
    description: 'Close-up torso shot of model, hands adjusting collar or hem, highlighting fabric texture and garment fit details, tight studio crop',
