...
export interface CategoryPage {
  ...
  heroCollage?: { subCategory: string; imageId: string; alt: string; videoSrc?: string }[];
}
...
export const aiProductPhotographyCategoryPages: CategoryPage[] = [
  ...
  // ─────────────────────────────────────── 5. JEWELRY
  {
    ...
    sceneExamples: [
      ...
      { label: 'Editorial Neck Portrait',      category: 'Editorial Neck Studio',    imageId: '1781094448800-p8owdm', collectionLabel: 'Necklaces', subCategory: 'Editorial Neck Studio',   alt: 'AI jewelry product photography example: editorial neck necklace portrait.' },
      { label: 'Mediterranean Sun Necklace',   category: 'Lifestyle Editorial',      imageId: '1781079796604-6n66k3', collectionLabel: 'Necklaces', subCategory: 'Lifestyle Editorial',     alt: 'AI jewelry product photography example: Mediterranean sun lifestyle necklace editorial.' },
  ...
  // ─────────────────────────────────────── 7. HOME & FURNITURE
  {
    ...
    h1Lead: 'AI Photography for',
    h1Highlight: 'Furniture & Home Decor',
    heroEyebrow: 'Furniture · Rooms · Decor',
    heroSubheadline:
      'Drop any furniture or decor piece into styled rooms — PDPs, lifestyle, and catalog visuals from one photo',
    heroCollage: [
    ...
    secondaryKeywords: [
      ...
      'living room product photography',
      'bedroom furniture photography',
      'dining room product photos',
      'outdoor furniture photography',
      'interior product photography',
    ],
    longTailKeywords: [
      'AI living room scenes for furniture brands',
      'AI bedroom furniture photos',
      'AI outdoor furniture lifestyle photos',
      'AI home office furniture photos',
      'AI product photography for home decor brands',
      'generate styled room photos with AI',
    ],
    subcategories: ['Living Room', 'Bedroom', 'Dining Room', 'Home Office', 'Hallway', 'Outdoor Furniture', 'Child Room', 'Editorial Room Heroes', 'Lived-In Lifestyle', 'Home Decor', 'Vases', 'Candles', 'Lighting', 'Sofas', 'Chairs'],
    painPoints: [
      'Home products need scale, material realism, interior context, and atmosphere.',
      'Furniture sells better in styled rooms, but booking a different set per room — living, bedroom, dining, outdoor — is slow and expensive.',
      'Brands need PDP photos, lifestyle inspiration, Pinterest-style visuals, ads, and catalog consistency across hundreds of SKUs.',
      'Producing in-context interior photography traditionally requires set design, location budgets, and seasonal reshoots.',
    ],
    visualOutputs: [
      { title: 'Editorial living rooms', text: 'Grand salons and lived-in living scenes.',         icon: 'sparkles' },
      { title: 'Bedroom suites',         text: 'Linen-soft, oak, and Japandi bedroom interiors.', icon: 'image' },
      { title: 'Dining halls',           text: 'Travertine, oak, and modern dining rooms.',       icon: 'layout-template' },
      { title: 'Home office studios',    text: 'Concrete architect studios and warm workspaces.', icon: 'camera' },
      { title: 'Outdoor terraces',       text: 'Mediterranean stone, garden, and patio settings.', icon: 'rocket' },
      { title: 'Decor lifestyle',        text: 'Console, shelf, and vase styling stories.',       icon: 'instagram' },
      { title: 'Catalog PDP shots',      text: 'Crisp, material-true catalog imagery.',           icon: 'shopping-bag' },
      { title: 'Seasonal campaigns',     text: 'Visuals tuned for every season and drop.',        icon: 'calendar' },
    ],
    sceneExamples: [
      { label: 'Grand Atelier Salon',         category: 'Living Room',  imageId: '1778050204000-gl9kym', collectionLabel: 'Furniture',  subCategory: 'Living Room',  alt: 'AI furniture product photography example: grand atelier salon living room scene.' },
      { label: 'Linen Cloud Suite',           category: 'Bedroom',      imageId: '1778048568910-lx1q0n', collectionLabel: 'Furniture',  subCategory: 'Bedroom',      alt: 'AI furniture product photography example: linen cloud bedroom suite.' },
      { label: 'Warm Travertine Dining Hall', category: 'Dining Room',  imageId: '1778071100932-306rp9', collectionLabel: 'Furniture',  subCategory: 'Dining Room',  alt: 'AI furniture product photography example: warm travertine dining hall.' },
      { label: 'Concrete Architect Studio',   category: 'Home Office',  imageId: '1778049958891-reu4vd', collectionLabel: 'Furniture',  subCategory: 'Home Office',  alt: 'AI furniture product photography example: concrete architect home office studio.' },
      { label: 'Mediterranean Stone Terrace', category: 'Outdoor',      imageId: '1778061177176-1ii0an', collectionLabel: 'Furniture',  subCategory: 'Outdoor',      alt: 'AI outdoor furniture product photography example: mediterranean stone terrace.' },
      { label: 'Parisian Entry Hall',         category: 'Hallway',      imageId: '1778058451812-aypoov', collectionLabel: 'Furniture',  subCategory: 'Hallway',      alt: 'AI furniture product photography example: parisian entry hall scene.' },
      { label: 'Penthouse Panorama Lounge',   category: 'Living Room',  imageId: '1778050207308-nxynq0', collectionLabel: 'Furniture',  subCategory: 'Living Room',  alt: 'AI furniture product photography example: penthouse panorama living lounge.' },
      { label: 'Parisian Pied-à-Terre',       category: 'Bedroom',      imageId: '1778048570142-is382n', collectionLabel: 'Furniture',  subCategory: 'Bedroom',      alt: 'AI furniture product photography example: parisian pied-à-terre bedroom.' },
      { label: 'Midnight Lacquer Dining',     category: 'Dining Room',  imageId: '1778071095634-2sibfj', collectionLabel: 'Furniture',  subCategory: 'Dining Room',  alt: 'AI furniture product photography example: midnight lacquer dining room.' },
      { label: 'Natural Oak Study',           category: 'Home Office',  imageId: '1778049960507-2b013v', collectionLabel: 'Furniture',  subCategory: 'Home Office',  alt: 'AI furniture product photography example: natural oak home office study.' },
      { label: 'Hamptons White Porch',        category: 'Outdoor',      imageId: '1778061174654-hrspoo', collectionLabel: 'Furniture',  subCategory: 'Outdoor',      alt: 'AI outdoor furniture product photography example: hamptons white porch.' },
      { label: 'Color Wall Decor Hero',       category: 'Home Decor',   imageId: '1776588673759-kwlh8f', collectionLabel: 'Home Decor', subCategory: 'Aesthetic Color Decor Stories', alt: 'AI home decor product photography example: aesthetic color wall decor hero.' },
    ],
    useCases: [
    ...
    faqs: [
      { q: 'Can AI create furniture and home decor product photos?', a: 'Yes. Generate PDP shots, styled rooms, lifestyle visuals, and catalog imagery for furniture and decor brands.' },
      { q: 'Can VOVV.AI generate room-specific scenes (living, bedroom, dining, outdoor)?', a: 'Yes. Living rooms, bedrooms, dining rooms, home offices, hallways, child rooms, and outdoor terraces are all built-in scene types.' },
      { q: 'Can VOVV.AI place furniture into realistic interiors?', a: 'Yes — modern, minimal, Japandi, Parisian, Mediterranean, and a wide range of interior moods are supported.' },
    ...
    heroImageId: '1778050204000-gl9kym',
    heroAlt: 'AI furniture product photography example showing a grand atelier salon living room scene.',
    heroNoun: 'piece',
  },
  ...
  // ─────────────────────────────────────── 9. SUPPLEMENTS & WELLNESS
  {
    ...
    subcategories: ['Supplements', 'Vitamins', 'Protein Tubs', 'Wellness Products', 'Capsules', 'Powders', 'Pouches', 'Outdoor Editorial', 'Fitness Scenes'],
    painPoints: [
    ...
    sceneExamples: [
      { label: 'Soft Ritual Hold',           category: 'Editorial Wellness Routine', imageId: '1779945336044-l182le', collectionLabel: 'Supplements & Wellness', subCategory: 'Editorial Wellness Routine', alt: 'AI supplement product photography example: soft editorial ritual hold of a wellness bottle.' },
      { label: 'Pure Joy Glow',              category: 'Editorial Wellness Routine', imageId: '1779945504810-74fe51', collectionLabel: 'Supplements & Wellness', subCategory: 'Editorial Wellness Routine', alt: 'AI supplement product photography example: pure joy glow editorial wellness moment.' },
      { label: 'Glossed Wellness Close-Up',  category: 'Editorial Wellness Routine', imageId: '1779910171858-94bets', collectionLabel: 'Supplements & Wellness', subCategory: 'Editorial Wellness Routine', alt: 'AI supplement product photography example: glossed editorial wellness close-up.' },
      { label: 'Sunlit Ritual Hand Hold',    category: 'Editorial Wellness Routine', imageId: '1779911299275-6ksf6d', collectionLabel: 'Supplements & Wellness', subCategory: 'Editorial Wellness Routine', alt: 'AI supplement product photography example: sunlit ritual hand hold.' },
      { label: 'Coastal Cliff',              category: 'Outdoor Editorial',          imageId: '1779910172676-4krpnw', collectionLabel: 'Supplements & Wellness', subCategory: 'Outdoor Editorial',          alt: 'AI supplement product photography example: coastal cliff outdoor editorial scene.' },
      { label: 'Beachside Supplement Ritual', category: 'Outdoor Editorial',         imageId: '1779911321508-v9n6qu', collectionLabel: 'Supplements & Wellness', subCategory: 'Outdoor Editorial',          alt: 'AI supplement product photography example: beachside supplement ritual.' },
      { label: 'Sky Product Portrait',       category: 'Creative Shots',             imageId: '1779908989824-srme6q', collectionLabel: 'Supplements & Wellness', subCategory: 'Creative Shots',             alt: 'AI supplement product photography example: sky product portrait creative shot.' },
      { label: 'Brutalist Concrete',         category: 'Creative Shots',             imageId: '1779910171054-jwwlkk', collectionLabel: 'Supplements & Wellness', subCategory: 'Creative Shots',             alt: 'AI supplement product photography example: brutalist concrete creative still life.' },
    ],
    useCases: [
    ...
    heroImageId: '1779945336044-l182le',
    heroAlt: 'AI supplement product photography example showing a soft editorial wellness ritual hold.',
    heroNoun: 'product',
  },
  ...
  // ─────────────────────────────────────── 11. BAGS (sub-niche)
  {
    ...
    heroSubheadline:
      'Studio, on-body and campaign visuals generated by AI from one product photo',
    primaryKeyword: 'AI bag product photography',
    secondaryKeywords: [
      'bag product photography',
      'handbag product photography',
  ...
  // ─────────────────────────────────────── 13. HOODIES
  {
    ...
    heroSubheadline:
      'Cozy editorials, off-duty streetwear and campaign visuals generated by AI from one product photo',
  ...
  // ─────────────────────────────────────── 14. SWIMWEAR
  {
    ...
    heroSubheadline:
      'Resort editorials, poolside lifestyle and campaign visuals generated by AI from one product photo',
    ...
    sceneExamples: [
      { label: 'Maldives It Girl',                  category: 'Editorial Resort Poses',     imageId: '1779343672535-j0u73e', collectionLabel: 'Swimwear', subCategory: 'Editorial Resort Poses',     alt: 'AI swimwear product photography example: Maldives editorial resort portrait.' },
      { label: 'White Lotus Glow',                  category: 'Aesthetic Color Stories',    imageId: '1779347039851-qiw1ib', collectionLabel: 'Swimwear', subCategory: 'Aesthetic Color Stories',    alt: 'AI swimwear product photography example: White Lotus aesthetic color resort glow.' },
      { label: 'Cape Town Siren',                   category: 'Editorial Resort Poses',     imageId: '1779344951443-20h9xc', collectionLabel: 'Swimwear', subCategory: 'Editorial Resort Poses',     alt: 'AI swimwear product photography example: Cape Town coastal editorial siren.' },
      { label: 'Poolside Fever Dream',              category: 'Pool / Beach Lifestyle UGC', imageId: '1779344965626-u2ro8h', collectionLabel: 'Swimwear', subCategory: 'Pool / Beach Lifestyle UGC', alt: 'AI swimwear product photography example: poolside fever dream lifestyle scene.' },
      { label: 'Aegean Deck Siren',                 category: 'Editorial Resort Poses',     imageId: '1779346999911-klrly1', collectionLabel: 'Swimwear', subCategory: 'Editorial Resort Poses',     alt: 'AI swimwear product photography example: Aegean deck editorial portrait.' },
      { label: 'Sandy Towel Surface Detail',        category: 'Wet Surface Stills',         imageId: '1776246325029-44re6c', collectionLabel: 'Swimwear', subCategory: 'Wet Surface Stills',         alt: 'AI swimwear product photography example: sandy towel surface still detail.' },
      { label: 'Villa Espresso Walk',               category: 'Pool / Beach Lifestyle UGC', imageId: '1779347030368-pgte54', collectionLabel: 'Swimwear', subCategory: 'Pool / Beach Lifestyle UGC', alt: 'AI swimwear product photography example: villa espresso walk lifestyle moment.' },
      { label: 'Maldives Palm Girl',                category: 'Editorial Resort Poses',     imageId: '1779343681835-hd7hp3', collectionLabel: 'Swimwear', subCategory: 'Editorial Resort Poses',     alt: 'AI swimwear product photography example: Maldives palm tree editorial portrait.' },
      { label: 'Villa Shade Siren',                 category: 'Villa & Resort Mood',        imageId: '1779347035251-z5k8cv', collectionLabel: 'Swimwear', subCategory: 'Villa & Resort Mood',        alt: 'AI swimwear product photography example: villa shade siren editorial portrait.' },
      { label: 'Poolside Double Take',              category: 'Pool / Beach Lifestyle UGC', imageId: '1779347015401-sti2jy', collectionLabel: 'Swimwear', subCategory: 'Pool / Beach Lifestyle UGC', alt: 'AI swimwear product photography example: poolside double-take candid moment.' },
      { label: 'Maldives Bicycle Girl',             category: 'Editorial Resort Poses',     imageId: '1779343666035-zdhcpb', collectionLabel: 'Swimwear', subCategory: 'Editorial Resort Poses',     alt: 'AI swimwear product photography example: Maldives bicycle resort scene.' },
      { label: 'Coastal Stillness Swim Frame',      category: 'Wet Surface Stills',         imageId: '1777996830864-yd13ny', collectionLabel: 'Swimwear', subCategory: 'Wet Surface Stills',         alt: 'AI swimwear product photography example: coastal stillness swim still life.' },
    ],
    useCases: [
    ...
    heroCollage: [
      ...
      { subCategory: 'Video',     imageId: '1776522810241-oh3lyd', alt: 'AI swimwear sunlit arch editorial.', videoSrc: swimwearMotion4 },
      { subCategory: 'Editorial', imageId: '1776246331485-jyrtgf', alt: 'AI swimwear towel wrap after swim UGC.' },
      { subCategory: 'Lifestyle', imageId: '1776246310078-jeoctl', alt: 'AI swimwear folded on towel hero still.' },
    ],
  },
  ...
  // ─────────────────────────────────────── 16. EYEWEAR
  {
    ...
    heroSubheadline:
      'Editorial portraits, vintage film campaigns and on-model frame stories generated by AI from one product photo',
  ...
  // ─────────────────────────────────────── 17. ACTIVEWEAR
  {
    ...
    seoTitle: 'AI Activewear Product Photography for Sport Brands | VOVV.AI',
    metaDescription:
      'AI activewear product photography for sport, gym, and yoga brands. Turn one piece into editorial sport poses, pilates studios, court stories, and PDP angles.',
    h1Lead: 'AI activewear photography,',
    h1Highlight: 'from a single upload',
    heroEyebrow: 'Pilates · Studio · Court',
    heroSubheadline:
      'Pilates editorials, studio portraits and on-model sport visuals generated by AI from one product photo',
    primaryKeyword: 'AI activewear product photography',
    secondaryKeywords: [
      'activewear product photography',
      'sportswear product photography',
      'gym wear ecommerce photography',
      'AI yoga clothing photos',
      'leggings product photography',
    ],
    longTailKeywords: [
      'AI product photography for activewear brands',
      'AI sportswear photos for Shopify',
      'generate pilates editorial visuals from one photo',
      'aesthetic gym UGC content with AI',
    ],
    subcategories: ['Leggings', 'Sports Bras', 'Sets', 'Shorts', 'Tanks', 'Outerwear'],
    painPoints: [
      'Sport brands need fit, drape, and stretch to read clearly across PDP, ads, and social.',
      'Performance shoots are expensive — gyms, courts, models, and lighting add up fast.',
      'Drops need pilates, court, gym, and street scenes in one consistent aesthetic.',
      'Aesthetic UGC sets the conversion tone for activewear brands today.',
    ],
    visualOutputs: [
      { title: 'Editorial sport portraits',  text: 'Standing elongation, balance poses, and chair core editorials.', icon: 'sparkles' },
      { title: 'Pilates & studio scenes',    text: 'Window light pilates, floor stretches, and translucent studios.', icon: 'image' },
      { title: 'Aesthetic color sets',       text: 'Hero, mirror UGC, soft gym, and court color stories.',           icon: 'camera' },
      { title: 'Court & track stories',      text: 'Tennis court, track field, and golden hour court editorials.',   icon: 'layout-template' },
      { title: 'On-model PDP angles',        text: 'Front, back, fit closeups, and waistband detail shots.',         icon: 'shopping-bag' },
      { title: 'Lifestyle scenes',           text: 'City corner ease, café focus, sunlit floor moments.',             icon: 'instagram' },
      { title: 'Campaign hero visuals',      text: 'Editorial sport heroes for season and capsule launches.',        icon: 'rocket' },
      { title: 'Social ad creatives',        text: 'High-CTR creative variants for Meta, TikTok, and Pinterest.',    icon: 'megaphone' },
    ],
    sceneExamples: [
      { label: 'Aesthetic Sport Hero',        category: 'Aesthetic Color Sets',   imageId: '1776231751417-v0kjpy', collectionLabel: 'Activewear', subCategory: 'Aesthetic Color Sets',   alt: 'AI activewear product photography example: aesthetic sport color hero.' },
      { label: 'Editorial Floor Stretch',     category: 'Editorial Sport Poses',  imageId: '1776192312181-3v0u0t', collectionLabel: 'Activewear', subCategory: 'Editorial Sport Poses',  alt: 'AI activewear product photography example: editorial floor stretch pose.' },
      { label: 'Window Light Pilates Pose',   category: 'Editorial Sport Poses',  imageId: '1776231822346-2f1iqc', collectionLabel: 'Activewear', subCategory: 'Editorial Sport Poses',  alt: 'AI activewear product photography example: window light pilates pose.' },
      { label: 'Standing Elongation Pose',    category: 'Editorial Sport Poses',  imageId: '1776768268121-ceu2p2', collectionLabel: 'Activewear', subCategory: 'Editorial Sport Poses',  alt: 'AI activewear product photography example: standing elongation pose.' },
      { label: 'Pilates Studio Glow',         category: 'Creative Editorial',     imageId: '1776838044202-kb4bib', collectionLabel: 'Activewear', subCategory: 'Creative Editorial',     alt: 'AI activewear product photography example: pilates studio glow.' },
      { label: 'Tennis Court',                category: 'Lifestyle & Studio',     imageId: '1776838051066-9iqjlv', collectionLabel: 'Activewear', subCategory: 'Lifestyle & Studio',     alt: 'AI activewear product photography example: tennis court editorial.' },
      { label: 'Aesthetic UGC Mirror',        category: 'Aesthetic Color Sets',   imageId: '1776231776420-wmermo', collectionLabel: 'Activewear', subCategory: 'Aesthetic Color Sets',   alt: 'AI activewear product photography example: aesthetic UGC mirror selfie.' },
      { label: 'Waistband Fit Closeup',       category: 'PDP Detail',             imageId: '1776768269222-mp7its', collectionLabel: 'Activewear', subCategory: 'PDP Detail',             alt: 'AI activewear product photography example: waistband fit closeup.' },
    ],
    useCases: [
      { title: 'Shopify product pages',  text: 'PDP heroes and fit closeups for every SKU.',              icon: 'shopping-bag' },
      { title: 'Drop campaigns',         text: 'Editorial sport heroes ready for collection launches.',   icon: 'rocket' },
      { title: 'Meta and TikTok ads',    text: 'High-CTR creative variations for performance testing.',   icon: 'megaphone' },
      { title: 'Always-on social',       text: 'Pilates, court, and gym UGC content for IG and TikTok.',  icon: 'instagram' },
      { title: 'Lookbooks',              text: 'Editorial spreads for capsule and seasonal sets.',         icon: 'layout-template' },
      { title: 'Email banners',          text: 'Premium hero imagery for newsletters and promos.',         icon: 'mail' },
    ],
    faqs: [
      { q: 'Can AI create activewear product photos?',                 a: 'Yes. Upload one piece and VOVV.AI generates editorial sport poses, pilates studios, aesthetic color sets, and PDP angles tailored to sport brands.' },
      { q: 'Can VOVV.AI preserve fabric, stretch, and fit?',           a: 'VOVV.AI is built to preserve fabric drape, color accuracy, and silhouette so fit reads clearly. Always review final visuals before publishing.' },
      { q: 'Can I create gym and pilates visuals without a shoot?',    a: 'Yes — pilates studios, court stories, track field, and translucent studios are all core outputs.' },
      { q: 'Can I create activewear photos for Shopify?',              a: 'Yes. The output is sized and styled for Shopify PDPs, collection grids, banners, and ads.' },
      { q: 'Can I generate aesthetic UGC sets for activewear?',        a: 'Yes. Mirror UGC, soft gym, and aesthetic court stories are part of the activewear scene library.' },
    ],
    relatedCategories: ['fashion', 'swimwear', 'hoodies', 'footwear'],
    heroImageId: '1776231751417-v0kjpy',
    heroAlt: 'AI activewear product photography example showing an aesthetic color sport hero set.',
  ...
  // ─────────────────────────────────────── 18. DRESSES
  {
    ...
    url: `${BASE}/dresses`,
    groupName: 'Dresses',
    seoTitle: 'AI Dress Product Photography for Womenswear Brands | VOVV.AI',
    metaDescription:
      'AI dress product photography for womenswear and contemporary brands. Turn one dress into editorial portraits, quiet luxury locations, and PDP angles.',
    h1Lead: 'AI Dress Product Photography',
    h1Highlight: 'for Womenswear Brands',
    heroEyebrow: 'Dresses · Womenswear · Editorial',
    heroSubheadline:
      'Upload one dress and create editorial portraits, quiet luxury location stories, studio campaign heroes, and on-model PDP angles — without booking a destination',
    primaryKeyword: 'AI dress product photography',
    secondaryKeywords: [
      'dress product photography',
      'womenswear product photography',
      'AI fashion dress photos',
      'editorial dress portrait photography',
      'dress ecommerce photography',
    ],
    longTailKeywords: [
      'AI product photography for dress brands',
      'AI dress photos for Shopify',
      'generate quiet luxury editorials from one dress photo',
      'editorial campaign visuals for womenswear with AI',
    ],
    subcategories: ['Mini', 'Midi', 'Maxi', 'Slip', 'Knit', 'Evening', 'Bridal'],
    painPoints: [
      'Dress drape, length, and fabric flow have to read accurately at a glance.',
      'Editorial portrait shoots are expensive and slow to direct for every drop.',
      'Brands need quiet luxury locations without booking villas, fountains, or museums.',
      'Campaign and PDP need a consistent aesthetic across the whole capsule.',
    ],
    visualOutputs: [
      { title: 'Editorial dress portraits', text: 'Side leans, attitude poses, glamour flash, and statement portraits.', icon: 'sparkles' },
      { title: 'Quiet luxury locations',    text: 'Seaside terraces, Roman fountains, museum staircases, dusk stone.',   icon: 'image' },
      { title: 'Studio editorial heroes',   text: 'Sheer knit, leg accent, side profile, and front portrait heroes.',     icon: 'camera' },
      { title: 'Campaign statements',       text: 'Super editorial campaigns and flash night fashion shots.',             icon: 'rocket' },
      { title: 'On-model PDP angles',       text: 'Front, back, editorial, and movement product page shots.',             icon: 'shopping-bag' },
      { title: 'Flat-lay & detail stills',  text: 'Front flat lay, ghost mannequin, and texture detail shots.',           icon: 'layout-grid' },
      { title: 'Lookbook spreads',          text: 'Cohesive editorial spreads for capsule and bridal collections.',       icon: 'layout-template' },
      { title: 'Social ad creatives',       text: 'High-CTR variants for Meta, TikTok, and Pinterest.',                   icon: 'megaphone' },
    ],
    sceneExamples: [
      { label: 'Super Editorial Campaign',     category: 'Studio Editorial',       imageId: '1776689322212-9lsvah', collectionLabel: 'Dresses', subCategory: 'Studio Editorial',       alt: 'AI dress product photography example: super editorial campaign.' },
      { label: 'Side Lean Attitude Pose',      category: 'Editorial Portraits',    imageId: '1776689321496-nclkyc', collectionLabel: 'Dresses', subCategory: 'Editorial Portraits',    alt: 'AI dress product photography example: side lean attitude pose.' },
      { label: 'Seaside Terrace Dress',        category: 'Quiet Luxury Locations', imageId: '1776688418783-twv612', collectionLabel: 'Dresses', subCategory: 'Quiet Luxury Locations', alt: 'AI dress product photography example: seaside terrace dress.' },
      { label: 'Renaissance Dress',            category: 'Quiet Luxury Locations', imageId: '1776688415791-80vl3l', collectionLabel: 'Dresses', subCategory: 'Quiet Luxury Locations', alt: 'AI dress product photography example: renaissance staircase dress.' },
      { label: 'Mini Dress Studio Look',       category: 'Studio Editorial',       imageId: '1776688404914-wwy92r', collectionLabel: 'Dresses', subCategory: 'Studio Editorial',       alt: 'AI dress product photography example: mini dress studio look.' },
      { label: 'Flash Glamour Portrait',       category: 'Editorial Portraits',    imageId: '1776689317300-luvmhd', collectionLabel: 'Dresses', subCategory: 'Editorial Portraits',    alt: 'AI dress product photography example: flash glamour portrait.' },
      { label: 'Old Money Outdoor Portrait',   category: 'Editorial Portraits',    imageId: '1776689319922-8yiolc', collectionLabel: 'Dresses', subCategory: 'Editorial Portraits',    alt: 'AI dress product photography example: old money outdoor portrait.' },
      { label: 'On-Model Editorial',           category: 'Essential PDP Shots',    imageId: '1776688964471-eu2q1w', collectionLabel: 'Dresses', subCategory: 'Essential PDP Shots',    alt: 'AI dress product photography example: on-model editorial PDP.' },
    ],
    useCases: [
      { title: 'Shopify product pages',   text: 'PDP heroes and on-model alternates for every dress.',     icon: 'shopping-bag' },
      { title: 'Capsule campaigns',       text: 'Editorial heroes ready for capsule and bridal launches.', icon: 'rocket' },
      { title: 'Meta and TikTok ads',     text: 'High-CTR creative variations for performance testing.',   icon: 'megaphone' },
      { title: 'Always-on social',        text: 'Quiet luxury location and editorial portrait content.',   icon: 'instagram' },
      { title: 'Lookbooks',               text: 'Editorial spreads for season, bridal, and PR.',           icon: 'layout-template' },
      { title: 'Email banners',           text: 'Premium imagery for newsletters and promo banners.',      icon: 'mail' },
    ],
    faqs: [
      { q: 'Can AI create dress product photos?',                a: 'Yes. Upload one dress and VOVV.AI generates editorial portraits, quiet luxury locations, studio campaign heroes, and PDP angles.' },
      { q: 'Can VOVV.AI preserve fabric, drape, and color?',     a: 'VOVV.AI is built to preserve drape, length, and color accuracy so dress fit and fabric read clearly. Always review final visuals before publishing.' },
      { q: 'Can I create editorial location visuals without travel?', a: 'Yes — seaside terraces, Roman fountains, museum staircases, and quiet residential streets are all core outputs.' },
    ...
    heroNoun: 'dress',
    heroCollage: [
      { subCategory: 'Editorial', imageId: '1776689322212-9lsvah', alt: 'AI dress super editorial campaign.' },
      { subCategory: 'Location',  imageId: '1776688418783-twv612', alt: 'AI dress seaside terrace location.' },
      { subCategory: 'Studio',    imageId: '1776688404914-wwy92r', alt: 'AI dress mini studio look.' },
      { subCategory: 'Portrait',  imageId: '1776689321496-nclkyc', alt: 'AI dress side lean attitude pose.' },
    ],
  },
  ...
  // ─────────────────────────────────────── 19. CAPS & HATS
  {
    ...
    url: `${BASE}/caps-hats`,
    groupName: 'Caps & Hats',
    seoTitle: 'AI Cap & Hat Product Photography for Headwear Brands | VOVV.AI',
    metaDescription:
      'AI cap and hat product photography for headwear brands. Turn one cap into worn portraits, lifestyle editorials, aesthetic color film, and clean PDP shots.',
    h1Lead: 'AI Cap & Hat Product Photography',
    h1Highlight: 'for Headwear Brands',
    heroEyebrow: 'Caps · Hats · Headwear',
    heroSubheadline:
      'Upload one cap or hat and create worn portraits, brim-grip lifestyle shots, aesthetic color film editorials, and clean PDP angles — ready for Shopify and ads',
    primaryKeyword: 'AI cap product photography',
    secondaryKeywords: [
      'hat product photography',
      'cap ecommerce photography',
      'AI headwear photos',
      'streetwear cap photography',
      'bucket hat product photography',
    ],
    longTailKeywords: [
      'AI product photography for cap brands',
      'AI hat photos for Shopify',
      'generate worn portrait visuals from one cap photo',
      'aesthetic streetwear cap UGC with AI',
    ],
    subcategories: ['Baseball Caps', 'Snapbacks', 'Trucker', 'Bucket Hats', 'Beanies', 'Wide-Brim'],
    painPoints: [
      'Cap shape, brim curve, and embroidery have to hold up under zoom on PDP.',
      'Worn portraits are essential — but model shoots get expensive fast.',
      'Brands need both clean PDP angles and lifestyle editorial in one aesthetic.',
      'Streetwear caps need bold color stories and street-feel shots for social.',
    ],
    visualOutputs: [
      { title: 'Worn portraits',           text: 'Brim grip, smile lean, hoodie close, and street fisheye portraits.',  icon: 'sparkles' },
      { title: 'Lifestyle editorials',     text: 'City coffee, court crouch, sky hold, and knit pull moments.',          icon: 'image' },
      { title: 'Aesthetic color film',     text: 'Mirror peek, beach crop, sun stairs, and shadow brim color stories.',  icon: 'camera' },
      { title: 'Clean PDP shots',          text: 'Front, back, side, top, worn portrait, and close-up detail angles.',   icon: 'shopping-bag' },
      { title: 'Creative hero visuals',    text: 'Volcanic sunset, water splash, and earthy glow stage editorials.',     icon: 'rocket' },
      { title: 'Negative space heroes',    text: 'Studio negative space hero compositions for collection covers.',       icon: 'layout-grid' },
      { title: 'Streetwear UGC',           text: 'Street fisheye, overhead selfie, and lounge knit UGC shots.',          icon: 'instagram' },
      { title: 'Social ad creatives',      text: 'High-CTR variants for Meta, TikTok, and Pinterest.',                   icon: 'megaphone' },
    ],
    sceneExamples: [
      { label: 'Brim Grip Portrait',       category: 'Lifestyle Editorial',  imageId: '1776077321082-njy85m', collectionLabel: 'Caps & Hats', subCategory: 'Lifestyle Editorial',  alt: 'AI cap product photography example: brim grip portrait.' },
      { label: 'City Coffee Look',         category: 'Lifestyle Editorial',  imageId: '1776077324651-jdqinw', collectionLabel: 'Caps & Hats', subCategory: 'Lifestyle Editorial',  alt: 'AI cap product photography example: city coffee street look.' },
      { label: 'Mirror Peek',              category: 'Aesthetic Color Film', imageId: '1776077333467-wopowe', collectionLabel: 'Caps & Hats', subCategory: 'Aesthetic Color Film', alt: 'AI cap product photography example: mirror peek aesthetic crop.' },
      { label: 'Sun Stairs',               category: 'Aesthetic Color Film', imageId: '1776077345651-mjwtsd', collectionLabel: 'Caps & Hats', subCategory: 'Aesthetic Color Film', alt: 'AI cap product photography example: sun stairs editorial.' },
      { label: 'Worn Portrait',            category: 'Essential PDP Shots',  imageId: '1776077517342-xjig04', collectionLabel: 'Caps & Hats', subCategory: 'Essential PDP Shots',  alt: 'AI cap product photography example: worn portrait PDP shot.' },
      { label: 'Front View',               category: 'Essential PDP Shots',  imageId: '1776077505500-87jrxi', collectionLabel: 'Caps & Hats', subCategory: 'Essential PDP Shots',  alt: 'AI cap product photography example: front view PDP shot.' },
      { label: 'Negative Space Hero',      category: 'Creative Shots',       imageId: '1776077511477-279x0w', collectionLabel: 'Caps & Hats', subCategory: 'Creative Shots',       alt: 'AI cap product photography example: negative space studio hero.' },
      { label: 'Volcanic Sunset',          category: 'Creative Shots',       imageId: '1776844273629-b1c2cs', collectionLabel: 'Caps & Hats', subCategory: 'Creative Shots',       alt: 'AI cap product photography example: volcanic sunset creative shot.' },
    ],
    useCases: [
      { title: 'Shopify product pages', text: 'Clean PDP heroes and worn portrait alternates per SKU.',  icon: 'shopping-bag' },
      { title: 'Drop campaigns',        text: 'Editorial worn portraits ready for cap collection drops.',  icon: 'rocket' },
      { title: 'Meta and TikTok ads',   text: 'High-CTR creative variations for performance testing.',     icon: 'megaphone' },
      { title: 'Always-on social',      text: 'Street fisheye and lifestyle UGC content for IG and TikTok.', icon: 'instagram' },
      { title: 'Lookbooks',             text: 'Editorial spreads for capsule and seasonal capsules.',       icon: 'layout-template' },
      { title: 'Email banners',         text: 'Premium hero imagery for newsletters and promos.',           icon: 'mail' },
    ],
    faqs: [
      { q: 'Can AI create cap and hat product photos?',           a: 'Yes. Upload one cap or hat and VOVV.AI generates worn portraits, lifestyle editorials, aesthetic color film, and clean PDP angles.' },
      { q: 'Can VOVV.AI preserve cap shape, brim, and embroidery?', a: 'VOVV.AI is built to preserve cap silhouette, brim curve, and logo / embroidery detail. Always review final visuals before publishing.' },
      { q: 'Can I create worn portrait visuals without a model shoot?', a: 'Yes — brim grip, smile lean, hoodie close, and street fisheye portraits are all core outputs.' },
      { q: 'Can I create cap photos for Shopify?',                a: 'Yes. The output is sized and styled for Shopify PDPs, collection grids, banners, and ads.' },
      { q: 'Can I generate streetwear UGC for caps?',             a: 'Yes. Mirror peek, overhead selfie, and street fisheye are part of the cap and hat scene library.' },
    ],
    relatedCategories: ['fashion', 'hoodies', 'eyewear', 'bags-accessories'],
    heroImageId: '1776077321082-njy85m',
    heroAlt: 'AI cap product photography example showing a brim grip worn portrait.',
    heroNoun: 'cap',
    heroCollage: [
      { subCategory: 'Lifestyle', imageId: '1776077321082-njy85m', alt: 'AI cap brim grip portrait.' },
      { subCategory: 'Aesthetic', imageId: '1776077333467-wopowe', alt: 'AI cap mirror peek aesthetic.' },
      { subCategory: 'Essential', imageId: '1776077517342-xjig04', alt: 'AI cap worn portrait PDP.' },
      { subCategory: 'Creative',  imageId: '1776077511477-279x0w', alt: 'AI cap negative space hero.' },
    ],
  },
  ...
  // ─────────────────────────────────────── 20. WEDDING DRESSES
  {
    ...
    url: `${BASE}/wedding-dresses`,
    groupName: 'Wedding Dresses',
    seoTitle: 'AI Wedding Dress Photography for Bridal Brands | VOVV.AI',
    metaDescription:
      'AI wedding dress photography for bridal brands. Turn one gown photo into editorial bridal portraits, atelier studios, garden and villa scenes, and PDP angles.',
    h1Lead: 'AI wedding dress photography,',
    h1Highlight: 'from a single upload',
    heroEyebrow: 'Bridal · Editorial · Atelier',
    heroSubheadline:
      'Editorial bridal portraits, atelier studios and on-model gown visuals generated by AI from one product photo',
    primaryKeyword: 'AI wedding dress photography',
    secondaryKeywords: [
      'bridal product photography',
      'wedding gown photography',
      'AI bridal editorials',
      'wedding dress ecommerce photos',
      'bridal lookbook photography',
    ],
    longTailKeywords: [
      'AI product photography for wedding dress brands',
      'AI bridal photos for Shopify',
      'generate atelier bridal visuals from one photo',
      'editorial wedding gown campaigns with AI',
    ],
    subcategories: ['A-Line', 'Mermaid', 'Ball Gown', 'Sheath', 'Slip', 'Mini'],
    painPoints: [
      'Bridal shoots are the most expensive in fashion — chateaux, vintage cars, hair, makeup, and models stack up fast.',
      'Every gown needs editorial campaign, atelier PDP, lookbook and social — all in one consistent aesthetic.',
      'Seasonal collection launches need garden, villa, beach and chapel stories ready at once.',
      'Brides discover gowns on Pinterest and Instagram — feed-ready editorials drive bookings.',
    ],
    visualOutputs: [
      { title: 'Editorial bridal portraits',  text: 'Grand staircase veil, monumental arch, and cliffside goddess editorials.', icon: 'sparkles' },
      { title: 'Atelier studio scenes',       text: 'Linen curtain studio, atelier mirror, and sculpture studio portraits.',    icon: 'image' },
      { title: 'Garden & villa stories',      text: 'Tuscan estate walks, garden dip kiss, and orchard daydream editorials.',   icon: 'camera' },
      { title: 'Vintage car & getaway',       text: 'Roadster bridal exits, vintage car muse, and getaway car kisses.',         icon: 'layout-template' },
      { title: 'On-model PDP angles',         text: 'Front, back, train sweep, and silhouette detail shots.',                    icon: 'shopping-bag' },
      { title: 'Veil & train details',        text: 'Veil & bouquet pauses, symmetry train portraits, and shadow veils.',        icon: 'zoom-in' },
      { title: 'Campaign hero visuals',       text: 'Editorial bridal heroes for season and capsule launches.',                  icon: 'rocket' },
      { title: 'Social ad creatives',         text: 'High-CTR creative variants for Meta, TikTok, and Pinterest.',               icon: 'megaphone' },
    ],
    sceneExamples: [
      { label: 'Grand Staircase Veil',     category: 'Bridal Editorial', imageId: '1780307460213-9gm38b', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: grand staircase veil editorial.' },
      { label: 'Garden Dip Kiss',          category: 'Bridal Editorial', imageId: '1780308026963-vb0k3u', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: garden dip kiss couple editorial.' },
      { label: 'Vintage Car Bridal Muse',  category: 'Bridal Editorial', imageId: '1780307465927-8v9rzz', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: vintage car bridal muse.' },
      { label: 'Cliffside Goddess Gown',   category: 'Bridal Editorial', imageId: '1780309205809-7skt5e', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: cliffside goddess gown.' },
      { label: 'Atelier Mirror',           category: 'Bridal Editorial', imageId: '1778332154533-vr8cht', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: atelier mirror studio.' },
      { label: 'Tuscan Bridal Gown',       category: 'Bridal Editorial', imageId: '1780307463188-xreub7', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: tuscan bridal gown.' },
      { label: 'White Quarry Siren',       category: 'Bridal Editorial', imageId: '1780309229930-ydwdrm', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: white quarry siren.' },
      { label: 'Veil & Bouquet Pause',     category: 'Bridal Editorial', imageId: '1780309226612-pdloqt', collectionLabel: 'Wedding Dresses', subCategory: 'Bridal Editorial', alt: 'AI wedding dress product photography example: veil and bouquet pause.' },
    ],
    useCases: [
      { title: 'Shopify product pages',  text: 'PDP heroes and silhouette closeups for every gown.',     icon: 'shopping-bag' },
      { title: 'Collection launches',    text: 'Editorial bridal heroes ready for season campaigns.',    icon: 'rocket' },
      { title: 'Pinterest & Instagram',  text: 'Feed-ready editorials brides save and share.',           icon: 'instagram' },
      { title: 'Bridal lookbooks',       text: 'Editorial spreads for capsule and atelier collections.', icon: 'layout-template' },
      { title: 'Meta & TikTok ads',      text: 'High-CTR creative variations for performance testing.',  icon: 'megaphone' },
      { title: 'Email banners',          text: 'Premium hero imagery for newsletters and trunk shows.',  icon: 'mail' },
    ],
    faqs: [
      { q: 'Can AI create wedding dress photos?',                       a: 'Yes. Upload one gown and VOVV.AI generates editorial bridal portraits, atelier studios, garden and villa scenes, and PDP angles tailored to bridal brands.' },
      { q: 'Can VOVV.AI preserve fabric, drape, and silhouette?',       a: 'VOVV.AI is built to preserve fabric drape, gown color, and silhouette so the design reads clearly. Always review final visuals before publishing.' },
      { q: 'Can I create chateau and villa editorials without a shoot?', a: 'Yes — grand staircases, vintage cars, tuscan villas, cliffsides, and atelier studios are all core outputs.' },
      { q: 'Can I create wedding dress photos for Shopify?',            a: 'Yes. The output is sized and styled for Shopify PDPs, collection grids, banners, and ads.' },
      { q: 'Can I generate editorial bridal feeds for Instagram?',      a: 'Yes. Editorial portraits, vintage car moments, and atelier stories are part of the wedding dress scene library — ready for Pinterest and Instagram.' },
    ],
    relatedCategories: ['fashion', 'lingerie', 'swimwear', 'dresses'],
    heroImageId: '1780307460213-9gm38b',
  ...
  // ─────────────────────────────────────── 21. PHONE CASES (sub-niche)
  {
    slug: 'phone-cases',
    url: `${BASE}/phone-cases`,
    groupName: 'Phone Cases',
    seoTitle: 'AI Phone Case Photography for Accessory Brands | VOVV.AI',
    metaDescription:
      'AI phone case photography for accessory brands. Turn one case photo into editorial lifestyle visuals, poolside and pilates scenes, color flatlays, and PDP shots.',
    h1Lead: 'AI phone case photography,',
    h1Highlight: 'from a single upload',
    heroEyebrow: 'Editorial · Lifestyle · PDP',
    heroSubheadline:
      'Editorial lifestyle scenes, on-body closeups and color flatlays for phone case brands generated by AI from one product photo',
    primaryKeyword: 'AI phone case photography',
    secondaryKeywords: [
      'phone case product photography',
      'iPhone case photography',
      'MagSafe case visuals',
      'phone case lifestyle photos',
      'phone case ecommerce photos',
    ],
    longTailKeywords: [
      'AI product photography for phone case brands',
      'AI phone case photos for Shopify',
      'generate lifestyle phone case visuals from one photo',
      'phone case campaign images with AI',
    ],
    subcategories: ['Clear', 'MagSafe', 'Silicone', 'Leather', 'Printed', 'Wallet Cases'],
    painPoints: [
      'Phone case drops happen monthly — shooting every colorway with models is impossible to keep up with.',
      'Print-on-demand catalogs need hundreds of lifestyle visuals per pattern, not just flatlays.',
      'Cases sell on aesthetic — coastal, pilates, café, travel — and every aesthetic needs its own shoot.',
      'Pinterest and TikTok feeds drive phone case discovery; PDP packshots alone do not convert.',
    ],
    visualOutputs: [
      { title: 'Editorial lifestyle',     text: 'Coastal, stucco and seaside editorials styled around the case.',  icon: 'sparkles' },
      { title: 'Poolside & beach',        text: 'Saltwater glow, poolside rest and beach club call scenes.',       icon: 'image' },
      { title: 'Pilates & active',        text: 'Pilates selfies, sporty case breaks and on-the-go moments.',      icon: 'camera' },
      { title: 'Café & travel',           text: 'Jet set, resort and café lifestyle for travel-coded brands.',     icon: 'layout-template' },
      { title: 'Color flatlays',          text: 'Citrus, dynamic bloom and earthy minimal flatlays for catalogs.', icon: 'layout-grid' },
      { title: 'On-body closeups',        text: 'Glossy selfies, shoulder closeups and waist hold details.',       icon: 'zoom-in' },
      { title: 'Campaign heroes',         text: 'Editorial hero visuals for drops, capsules and seasonal launches.', icon: 'rocket' },
      { title: 'Social ad creatives',     text: 'High-CTR creative variants for Meta, TikTok, and Pinterest.',     icon: 'megaphone' },
    ],
    sceneExamples: [
      { label: 'Coastal Call',          category: 'Editorial Shots', imageId: '1779952756981-gnkhvd', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: coastal call editorial.' },
      { label: 'Saltwater Case Glow',   category: 'Editorial Shots', imageId: '1779952784987-6zcgd4', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: saltwater case glow.' },
      { label: 'Glossy Case Selfie',    category: 'Editorial Shots', imageId: '1779954089918-y30ofu', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: glossy case selfie.' },
      { label: 'Shoulder Case Closeup', category: 'Editorial Shots', imageId: '1779952794821-nirn7y', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: shoulder case closeup.' },
      { label: 'Pilates Case Selfie',   category: 'Lifestyle Shots', imageId: '1779952779562-ueyyov', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: pilates case selfie.' },
      { label: 'Sporty Case Break',     category: 'Lifestyle Shots', imageId: '1779952799672-sh4oyk', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: sporty case break.' },
      { label: 'Sun Kissed Case',       category: 'Editorial Shots', imageId: '1779952807944-dzh93u', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: sun kissed case.' },
      { label: 'Seaside Case Sip',      category: 'Editorial Shots', imageId: '1779952793141-k7fpmm', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: seaside case sip.' },
      { label: 'Stucco Case Pose',      category: 'Editorial Shots', imageId: '1779952801778-iw9yli', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: stucco case pose.' },
      { label: 'Seashell Sand Glow',    category: 'Editorial Shots', imageId: '1779952787283-lfo8u8', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: seashell sand glow.' },
      { label: 'Beach Club Call',       category: 'Lifestyle Shots', imageId: '1779954090967-4ngo0t', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: beach club call.' },
      { label: 'Resort Case Toast',     category: 'Lifestyle Shots', imageId: '1779952783861-lm6tmf', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: resort case toast.' },
      { label: 'Studio Case Pose',      category: 'Studio Shots',    imageId: '1779952806230-ieqbpt', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: studio case pose.' },
      { label: 'Dynamic Bloom Studio',  category: 'Creative Shots',  imageId: '1779954083352-msu7cd', collectionLabel: 'Phone Cases', subCategory: 'Creative Shots',  alt: 'AI phone case product photography example: dynamic bloom studio.' },
      { label: 'Earthy Minimal Shadow', category: 'Creative Shots',  imageId: '1779954084093-2vljbf', collectionLabel: 'Phone Cases', subCategory: 'Creative Shots',  alt: 'AI phone case product photography example: earthy minimal shadows.' },
      { label: 'Sunny Shadows',         category: 'Creative Shots',  imageId: '1779954084793-2r9mfk', collectionLabel: 'Phone Cases', subCategory: 'Creative Shots',  alt: 'AI phone case product photography example: sunny shadows creative.' },
    ],
    useCases: [
      { title: 'Shopify product pages',   text: 'PDP heroes and color variants for every case.',           icon: 'shopping-bag' },
      { title: 'Print-on-demand stores',  text: 'Lifestyle visuals scaled across hundreds of patterns.',   icon: 'layout-grid' },
      { title: 'Pinterest & Instagram',   text: 'Feed-ready aesthetics buyers save and share.',            icon: 'instagram' },
      { title: 'Lookbooks',               text: 'Editorial spreads for capsule and collaboration drops.',  icon: 'layout-template' },
      { title: 'Meta & TikTok ads',       text: 'High-CTR creative variations for performance testing.',   icon: 'megaphone' },
      { title: 'Email banners',           text: 'Premium hero imagery for newsletters and launches.',      icon: 'mail' },
    ],
    faqs: [
      { q: 'Can AI create phone case photos?',                          a: 'Yes. Upload one case and VOVV.AI generates editorial lifestyle visuals, poolside and pilates scenes, color flatlays, and PDP shots tailored to phone case brands.' },
      { q: 'Can VOVV.AI preserve the print, pattern, and color?',       a: 'VOVV.AI is built to preserve case color, print and pattern so the design reads clearly. Always review final visuals before publishing.' },
      { q: 'Can I keep the case shape and cutouts consistent?',         a: 'Yes — hard-surface geometry, edges, camera cutouts and MagSafe rings are preserved across scenes.' },
      { q: 'Can I create phone case photos for Shopify?',               a: 'Yes. Output is sized and styled for Shopify PDPs, collection grids, banners, and ads.' },
      { q: 'Can I generate lifestyle case visuals for Instagram?',      a: 'Yes. Editorial portraits, poolside moments and pilates scenes are part of the phone case scene library — ready for Pinterest and Instagram.' },
    ],
    relatedCategories: ['electronics-gadgets', 'bags-accessories', 'jewelry', 'fashion'],
    heroImageId: '1779952756981-gnkhvd',
    heroAlt: 'AI phone case product photography example showing a coastal call editorial lifestyle scene.',
    heroNoun: 'case',
    heroCollage: [
  ...
  // ─────────────────────────────────────── 22. SOCKS (sub-niche)
  {
    ...
    url: `${BASE}/socks`,
    groupName: 'Socks',
    seoTitle: 'AI Sock Photography for Hosiery & Apparel Brands | VOVV.AI',
    metaDescription:
      'AI sock photography for hosiery and apparel brands. Turn one sock photo into editorial on-leg scenes, sneaker pairings, lifestyle shots, studio flatlays, and PDP details.',
    h1Lead: 'AI sock photography,',
    h1Highlight: 'from a single upload',
    heroEyebrow: 'Editorial · On-Leg · Flatlay',
    heroSubheadline:
      'Editorial on-leg scenes, sneaker pairings, soft studio details and clean flatlays for sock and hosiery brands generated by AI from one product photo',
    primaryKeyword: 'AI sock photography',
    secondaryKeywords: [
      'sock product photography',
      'hosiery photography',
      'on-leg sock photos',
      'sock flatlay photography',
      'sock lifestyle photos',
    ],
    longTailKeywords: [
      'AI product photography for sock brands',
      'AI sock photos for Shopify',
      'generate on-leg sock visuals from one photo',
      'sock campaign images with AI',
    ],
    subcategories: ['Crew', 'Ankle', 'No-show', 'Knee-high', 'Athletic', 'Dress'],
    painPoints: [
      'Sock drops launch in dozens of colorways — booking leg models for every variant is impossible to scale.',
      'On-leg photography is fiddly: pose, calf shape, cuff height and shoe pairing all have to land.',
      'Knit detail, ribbing and patterns get flattened by lazy lifestyle photography.',
      'Pinterest and TikTok feeds drive sock discovery; PDP packshots alone do not convert.',
    ],
    visualOutputs: [
      { title: 'Editorial on-leg',     text: 'Quiet studio legwork, soft chairs and elevated leg portraits.',     icon: 'sparkles' },
      { title: 'Sneaker & athletic',   text: 'Sneaker-paired closeups, sunlit athletic and curbside shots.',     icon: 'image' },
      { title: 'Lifestyle moments',    text: 'Café benches, morning coffee curls and bedside leg lifts.',        icon: 'camera' },
      { title: 'Studio details',       text: 'Pull-up, point-toe and sock-hug detail shots for PDP.',            icon: 'zoom-in' },
      { title: 'Clean flatlays',       text: 'Crisp flatlays for catalogs and color variant grids.',             icon: 'layout-grid' },
      { title: 'Sporty luxe',          text: 'Sporty luxe steps and stone-step lifestyle for premium drops.',    icon: 'layout-template' },
      { title: 'Campaign heroes',      text: 'Editorial hero visuals for drops, capsules and seasonal launches.', icon: 'rocket' },
      { title: 'Social ad creatives',  text: 'High-CTR creative variants for Meta, TikTok, and Pinterest.',      icon: 'megaphone' },
    ],
    sceneExamples: [
      { label: 'Studio Sock Detail',         category: 'Editorial Shots', imageId: '1780561729765-k0cxep', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: studio sock detail.' },
      { label: 'Sock Pull-Up Detail',        category: 'Editorial Shots', imageId: '1780561753998-8v4ch1', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: sock pull-up detail.' },
      { label: 'Point-Toe Sock Pose',        category: 'Editorial Shots', imageId: '1780561781148-bydrlo', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: point-toe sock pose.' },
      { label: 'Stone Steps Sock Lifestyle', category: 'Editorial Shots', imageId: '1780561735998-4y8go4', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: stone steps sock lifestyle.' },
      { label: 'Sporty Luxe Steps',          category: 'Editorial Shots', imageId: '1780561743164-35a6ov', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: sporty luxe steps.' },
      { label: 'Elevated Legs Sock Studio',  category: 'Editorial Shots', imageId: '1780561809148-uezs3k', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: elevated legs sock studio.' },
      { label: 'Clean Flat-Lay Socks',       category: 'Creative Shots',  imageId: '1780561814214-1h7t2a', collectionLabel: 'Socks', subCategory: 'Creative Shots',  alt: 'AI sock product photography example: clean flat-lay socks.' },
      { label: 'Sneaker Sock Detail',        category: 'Editorial Shots', imageId: '1780561758765-d31zv2', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: sneaker sock detail.' },
      { label: 'Sunlit Athletic Socks',      category: 'Lifestyle Shots', imageId: '1780561722965-qmbl7f', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: sunlit athletic socks.' },
      { label: 'Off-Duty Sporty',            category: 'Lifestyle Shots', imageId: '1780561788931-yt6gea', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: off-duty sporty socks.' },
      { label: 'Preppy Curbside Sock',       category: 'Lifestyle Shots', imageId: '1780561775831-bdl9dx', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: preppy curbside sock.' },
      { label: 'Low Floor Athletic Socks',   category: 'Editorial Shots', imageId: '1780561799181-sbj36y', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: low floor athletic socks.' },
      { label: 'Floor Bridge Socks',         category: 'Editorial Shots', imageId: '1780561804798-xep5qv', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: floor bridge socks.' },
      { label: 'Side-Lying Leg Lift',        category: 'Editorial Shots', imageId: '1780561765448-svp02c', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: side-lying leg lift.' },
      { label: 'Sculpted Studio Socks',      category: 'Editorial Shots', imageId: '1780561771148-hdijht', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: sculpted studio socks.' },
      { label: 'Soft Studio Sock Hug',       category: 'Editorial Shots', imageId: '1780561748398-cyhaci', collectionLabel: 'Socks', subCategory: 'Editorial Shots', alt: 'AI sock product photography example: soft studio sock hug.' },
    ],
    useCases: [
      { title: 'Shopify product pages',   text: 'PDP heroes and color variants for every sock style.',         icon: 'shopping-bag' },
      { title: 'Hosiery drops',           text: 'Lifestyle visuals scaled across every colorway and pattern.', icon: 'layout-grid' },
      { title: 'Pinterest & Instagram',   text: 'Feed-ready aesthetics buyers save and share.',                icon: 'instagram' },
      { title: 'Lookbooks',               text: 'Editorial spreads for capsule and seasonal drops.',           icon: 'layout-template' },
      { title: 'Meta & TikTok ads',       text: 'High-CTR creative variations for performance testing.',       icon: 'megaphone' },
      { title: 'Email banners',           text: 'Premium hero imagery for newsletters and launches.',          icon: 'mail' },
    ],
    faqs: [
      { q: 'Can AI create sock photos?',                             a: 'Yes. Upload one sock and VOVV.AI generates editorial on-leg scenes, sneaker pairings, lifestyle moments, studio details and flatlays tailored to sock and hosiery brands.' },
      { q: 'Can VOVV.AI preserve the knit, ribbing and pattern?',    a: 'VOVV.AI is built to preserve sock color, knit, ribbing and pattern so the design reads clearly. Always review final visuals before publishing.' },
      { q: 'Can I create on-leg sock photos without a model shoot?', a: 'Yes — editorial on-leg portraits, side-lying leg lifts, bridge poses and sneaker pairings all render from a single product photo.' },
      { q: 'Can I create sock photos for Shopify?',                  a: 'Yes. Output is sized and styled for Shopify PDPs, collection grids, banners, and ads.' },
      { q: 'Can I generate sock lifestyle visuals for Instagram?',   a: 'Yes. Editorial on-leg shots, café bench moments and sneaker pairings are part of the sock scene library — ready for Pinterest and Instagram.' },
    ],
    relatedCategories: ['fashion', 'activewear', 'hoodies', 'footwear'],
    heroImageId: '1780561729765-k0cxep',
    heroAlt: 'AI sock product photography example showing an editorial studio sock detail scene.',
    heroNoun: 'sock',
    heroCollage: [
