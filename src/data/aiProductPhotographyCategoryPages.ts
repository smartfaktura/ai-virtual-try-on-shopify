...
export const aiProductPhotographyCategoryPages: CategoryPage[] = [
  ...
  // ─────────────────────────────────────── 7. HOME & FURNITURE
  {
    ...
    visualOutputs: [
      { title: 'Living room scenes',     text: 'Editorial salons and lived-in living rooms.',     icon: 'sparkles' },
      { title: 'Bedroom suites',         text: 'Linen, oak, and minimal bedroom interiors.',      icon: 'image' },
      { title: 'Dining room scenes',     text: 'Travertine, oak, and modern dining halls.',       icon: 'layout-template' },
      { title: 'Home office scenes',     text: 'Architect studios and concrete workspaces.',      icon: 'camera' },
      { title: 'Outdoor furniture',      text: 'Mediterranean terraces and garden settings.',     icon: 'rocket' },
      { title: 'Home decor lifestyle',   text: 'Console, shelf, and grouped styling stories.',    icon: 'instagram' },
      { title: 'Catalog product photos', text: 'Crisp catalog-ready PDP and studio shots.',       icon: 'shopping-bag' },
      { title: 'Seasonal home campaigns', text: 'Visuals tuned for every season and drop.',       icon: 'calendar' },
    ],
    sceneExamples: [
