...
export const aiProductPhotographyCategoryPages: CategoryPage[] = [
  ...
  // ─────────────────────────────────────── 21. PHONE CASES (sub-niche)
  {
    ...
    sceneExamples: [
      ...
      { label: 'Poolside Case Kiss',    category: 'Editorial Shots', imageId: '1779953205374-fogmii', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: poolside case kiss.' },
      { label: 'Pilates Case Selfie',   category: 'Editorial Shots', imageId: '1779952779562-ueyyov', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: pilates case selfie.' },
      { label: 'Citrus Case Flatlay',   category: 'Editorial Shots', imageId: '1779952985161-cerwur', collectionLabel: 'Phone Cases', subCategory: 'Editorial Shots', alt: 'AI phone case product photography example: citrus case flatlay.' },
