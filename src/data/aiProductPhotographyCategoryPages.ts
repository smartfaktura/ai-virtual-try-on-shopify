...
export const aiProductPhotographyCategoryPages: CategoryPage[] = [
  ...
  // ─────────────────────────────────────── 7. HOME & FURNITURE
  {
    ...
    sceneExamples: [
      ...
      { label: 'Mediterranean Stone Terrace', category: 'Outdoor Furniture',                    imageId: '1778061177176-1ii0an', collectionLabel: 'Furniture',  subCategory: 'Outdoor Furniture',                    alt: 'AI outdoor furniture product photography example: mediterranean stone terrace.' },
      ...
      { label: 'Lived-In Sofa Story',         category: 'Living Room',                          imageId: '1778050204000-gl9kym', collectionLabel: 'Furniture',  subCategory: 'Sofas',                                alt: 'AI furniture product photography example: lived-in sofa story in a warm living room.' },
      { label: 'Japandi Bedroom Calm',        category: 'Bedroom',                              imageId: '1778048568910-lx1q0n', collectionLabel: 'Furniture',  subCategory: 'Bedroom',                              alt: 'AI furniture product photography example: Japandi calm bedroom interior.' },
      { label: 'Oak Dining Chair Hero',       category: 'Dining Room',                          imageId: '1778071100932-306rp9', collectionLabel: 'Furniture',  subCategory: 'Chairs',                               alt: 'AI furniture product photography example: oak dining chair hero shot.' },
      { label: 'Garden Lounge Afternoon',     category: 'Outdoor Furniture',                    imageId: '1778061177176-1ii0an', collectionLabel: 'Furniture',  subCategory: 'Outdoor Furniture',                    alt: 'AI outdoor furniture product photography example: garden lounge afternoon scene.' },
