...
export const aiProductPhotographyCategoryPages: CategoryPage[] = [
  // ─────────────────────────────────────── 1. FASHION
  {
    ...
    sceneExamples: [
      ...
      { label: 'Super Editorial Campaign',  category: 'Studio Shots', imageId: '1776606017719-zzhgy7', collectionLabel: 'Clothing & Apparel', subCategory: 'Studio Shots', alt: 'AI fashion product photography example: super editorial campaign visual.' },
      { label: 'Ghost Mannequin Shot',      category: 'EDITORIAL',          imageId: '1776841027943-vetumj', collectionLabel: 'Clothing & Apparel', subCategory: 'EDITORIAL',          alt: 'AI fashion product photography example: clean ghost mannequin product page shot.' },
  ...
  // ─────────────────────────────────────── 3. BEAUTY & SKINCARE
  {
    ...
    sceneExamples: [
      ...
      { label: 'Front View',                category: 'EDITORIAL',                   imageId: '1776239813791-r7ih97', collectionLabel: 'Beauty & Skincare', subCategory: 'EDITORIAL',                   alt: 'AI skincare product photography example: clean essential PDP front view.' },
  ...
  // ─────────────────────────────────────── 4. FRAGRANCE
  {
    ...
    sceneExamples: [
      ...
      { label: 'Clean Packshot',        category: 'EDITORIAL',      imageId: 'clean-packshot-fragrance-1776013150532', collectionLabel: 'Fragrance', subCategory: 'EDITORIAL',      alt: 'AI perfume product photography example: clean essential packshot.' },
  ...
  // ─────────────────────────────────────── 5. JEWELRY
  {
    ...
    sceneExamples: [
      ...
      { label: 'Dark Campaign Necklace',       category: 'Studio Shots', imageId: '1776243903909-thrg8i', collectionLabel: 'Necklaces', subCategory: 'Studio Shots', alt: 'AI jewelry product photography example: dark campaign necklace statement.' },
  ...
  // ─────────────────────────────────────── 6. BAGS & ACCESSORIES
  {
    ...
    sceneExamples: [
      ...
      { label: 'Wind Shoulder Editorial',        category: 'Studio Shots',   imageId: '1776749559127-ra3hur',                          collectionLabel: 'Bags',     subCategory: 'Studio Shots',   alt: 'AI bag product photography example: campaign wind shoulder editorial.' },
  ...
  // ─────────────────────────────────────── 9. SUPPLEMENTS & WELLNESS
  {
    ...
    sceneExamples: [
      { label: 'Front View',                category: 'EDITORIAL',                imageId: '1776247484304-xpwv5f', collectionLabel: 'Supplements & Wellness', subCategory: 'EDITORIAL',                alt: 'AI supplement product photography example: clean essential PDP front view.' },
  ...
  // ─────────────────────────────────────── 11. BAGS (sub-niche)
  {
    ...
    visualOutputs: [
      ...
      { title: 'Studio Shots',       text: 'Wind, motion, and location-driven bag campaigns.',      icon: 'sparkles' },
      { title: 'EDITORIAL',        text: 'Macro detail of clasps, zippers, and stitching.',       icon: 'zoom-in' },
    ...
    sceneExamples: [
      ...
      { label: 'EDITORIAL & Craft Closeup',       category: 'EDITORIAL',              imageId: '1776749772492-j9qpsv', collectionLabel: 'Bags', subCategory: 'EDITORIAL',              alt: 'AI bag product photography example: hardware and craft macro close-up.' },
      { label: 'Reclined Studio Editorial',      category: 'EDITORIAL',              imageId: '1776749544620-sn4eh1', collectionLabel: 'Bags', subCategory: 'EDITORIAL',              alt: 'AI bag product photography example: reclined studio essential shot.' },
      ...
      { label: 'Distant Horizon Campaign',       category: 'Studio Shots',      imageId: '1776749523574-vyjz0j', collectionLabel: 'Bags', subCategory: 'Studio Shots',      alt: 'AI bag product photography example: distant horizon campaign visual.' },
    ],
    useCases: [
    ...
    heroCollage: [
      ...
      { subCategory: 'EDITORIAL',   imageId: '1776749772492-j9qpsv', alt: 'AI bag hardware and craft macro detail.' },
    ],
  },
  ...
  // ─────────────────────────────────────── 13. HOODIES
  {
    ...
    sceneExamples: [
      { label: 'Ghost Mannequin Shot',       category: 'EDITORIAL',           imageId: '1776847998023-tof7el', collectionLabel: 'Hoodies', subCategory: 'EDITORIAL',           alt: 'AI hoodie product photography example: clean ghost mannequin product page shot.' },
  ...
  // ─────────────────────────────────────── 17. ACTIVEWEAR
  {
    ...
    h1Lead: 'AI Activewear Product Photography',
    h1Highlight: 'for Sport & Performance Brands',
    heroEyebrow: 'Activewear · Sport · Studio',
    heroSubheadline:
      'Upload one activewear photo and create editorial sport portraits, pilates studio scenes, aesthetic color sets, and on-model PDP angles — without booking a fitness shoot',
    ...
    heroCollage: [
      ...
      { subCategory: 'Editorial', imageId: '1776192312181-3v0u0t', alt: 'AI activewear editorial floor stretch.' },
  ...
  // ─────────────────────────────────────── 18. DRESSES
  {
    ...
    visualOutputs: [
      ...
      { title: 'Studio Shots',       text: 'Super editorial campaigns and flash night fashion shots.',             icon: 'rocket' },
