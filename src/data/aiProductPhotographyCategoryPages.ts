...
export const aiProductPhotographyCategoryPages: CategoryPage[] = [
  ...
  // ─────────────────────────────────────── 10. ELECTRONICS & GADGETS
  {
    ...
    sceneExamples: [
      ...
      { label: 'Material & Hardware Detail', category: 'Editorial Tech Studio',         imageId: '1776590046055-x86fe6', collectionLabel: 'Tech / Devices', subCategory: 'Editorial Tech Studio',           alt: 'AI electronics product photography example: editorial material and hardware detail.' },
      { label: 'Café or Travel Use',       category: 'Desk / Hand / Daily Use UGC',     imageId: '1776590043948-xe7lpu', collectionLabel: 'Tech / Devices', subCategory: 'Desk / Hand / Daily Use UGC',     alt: 'AI electronics product photography example: café or travel use moment.' },
      { label: 'Paired Accessory Still',   category: 'Surface / Setup / Product Still Life', imageId: '1776250222626-h0gabu', collectionLabel: 'Tech / Devices', subCategory: 'Surface / Setup / Product Still Life', alt: 'AI electronics product photography example: paired accessory composition.' },
    ],
    useCases: [
      { title: 'Shopify product pages', text: 'PDP visuals and alternates.',                          icon: 'shopping-bag' },
